...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-04400ad374254e1ed"
		"eu-north-1" = "ami-0fb87594235e9660e"
		"ap-south-1" = "ami-010831160e921bba3"
		"eu-west-3" = "ami-03006d0a0e5dfc572"
		"eu-west-2" = "ami-0cd5dacf3ceae6634"
		"eu-west-1" = "ami-0e2c993c14ef2aa1d"
		"ap-northeast-2" = "ami-05ce44e2216883481"
		"me-south-1" = "ami-08ebdbe4491ea7167"
		"ap-northeast-1" = "ami-04c9307b09cacccb9"
		"sa-east-1" = "ami-04c2774bcb147757c"
		"ca-central-1" = "ami-0a3b1c770f14afa3a"
		"ap-east-1" = "ami-07ab602e4ce0d042a"
		"ap-southeast-1" = "ami-0aea4b6d34bd4fed7"
		"ap-southeast-2" = "ami-0f3f78cd8d3ad158f"
		"us-east-1" = "ami-029e97f1874042d16"
		"us-east-2" = "ami-00783c0695bc57084"
		"us-west-1" = "ami-02de8583fd141ce37"
		"us-west-2" = "ami-01348e0c863c39fd0"
		"ap-south-2" = "ami-0e315479fa679d28d"
		"eu-south-1" = "ami-0a22b63696101c78f"
		"eu-south-2" = "ami-04aab9d307b7f8baf"
		"me-central-1" = "ami-0fad111ccdca40bec"
		"il-central-1" = "ami-0a5f1f58f5486660c"
		"eu-central-2" = "ami-07551406591090f9f"
		"af-south-1" = "ami-0253bbac326620a26"
		"ap-northeast-3" = "ami-0c5548a4b1e651112"
		"ca-west-1" = "ami-04402c755c9dad377"
		"ap-southeast-3" = "ami-05b44d497f5fbbc31"
		"ap-southeast-4" = "ami-0d62803f0f5bd2c41"
  }
}
