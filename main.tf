...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-07974af67a41d989c"
		"eu-north-1" = "ami-054054803ff03ab55"
		"ap-south-1" = "ami-0640246ef2691f357"
		"eu-west-3" = "ami-03729c8f59a4475a4"
		"eu-west-2" = "ami-059b0fbe1e8be3732"
		"eu-west-1" = "ami-062358a67c5dbfe1b"
		"ap-northeast-2" = "ami-089dfed5ea323f890"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-02f6fbb64bcac0f30"
		"sa-east-1" = "ami-0a3996e6c825d67fb"
		"ca-central-1" = "ami-0779e50c3c23c328d"
		"ap-east-1" = "ami-030a12ba932790a0a"
		"ap-southeast-1" = "ami-0ea10ac730ebf6807"
		"ap-southeast-2" = "ami-04e76d95580eb010e"
		"us-east-1" = "ami-016e417cd2977d5d6"
		"us-east-2" = "ami-00b28fd96f92305f9"
		"us-west-1" = "ami-00a4fe57cd4f7ee5d"
		"us-west-2" = "ami-08c7a32f08b990e5d"
		"ap-south-2" = "ami-06b682c107da9ada9"
		"eu-south-1" = "ami-03da9d943514b4bb6"
		"eu-south-2" = "ami-0a2608ee8ac71cdd2"
		"me-central-1" = "ami-0a411b3eb5723c992"
		"il-central-1" = "ami-03c530048deb1e2f2"
		"eu-central-2" = "ami-0622cb696987807a8"
		"af-south-1" = "ami-0bd62d0ab99910b14"
		"ap-northeast-3" = "ami-0d941907802b47533"
		"ca-west-1" = "ami-00adc5eef8234bd58"
		"ap-southeast-3" = "ami-0c6a8e682eae821ae"
		"ap-southeast-4" = "ami-05b5c914e9fe1659f"
  }
}
