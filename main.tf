...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0e46ad2ce4227af23"
		"eu-north-1" = "ami-08d0fc6c2843a93b7"
		"ap-south-1" = "ami-0c8862d76de47dbb9"
		"eu-west-3" = "ami-00440e1e0b7467540"
		"eu-west-2" = "ami-08ca01fa29b2cdc50"
		"eu-west-1" = "ami-0a4253c1d8b046e4c"
		"ap-northeast-2" = "ami-0209eccd32e3e7dc5"
		"me-south-1" = "ami-04bab331a12d7f57a"
		"ap-northeast-1" = "ami-0cb3e8ec2d2840529"
		"sa-east-1" = "ami-01176b2751a2c3110"
		"ca-central-1" = "ami-02b723cd9c8334831"
		"ap-east-1" = "ami-0fe9882a5c60a413d"
		"ap-southeast-1" = "ami-0a1d92331d5e2c4c3"
		"ap-southeast-2" = "ami-038f3cb0cbae7623d"
		"us-east-1" = "ami-028d3389da0f14eb5"
		"us-east-2" = "ami-05ddee6713475cbc9"
		"us-west-1" = "ami-0221cafd093afbfde"
		"us-west-2" = "ami-072857b95865169e9"
  }
}
