...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0c297557ac1f8416d"
		"eu-north-1" = "ami-025022463f2a6b7a1"
		"ap-south-1" = "ami-058d5602d28833080"
		"eu-west-3" = "ami-05097215b9a0efab3"
		"eu-west-2" = "ami-065f7a247987290b5"
		"eu-west-1" = "ami-060ef788542ac3c2c"
		"ap-northeast-2" = "ami-0151fd89052a96acd"
		"me-south-1" = "ami-0bdd196f6706d2a44"
		"ap-northeast-1" = "ami-0559bbaed24e70194"
		"sa-east-1" = "ami-0c52bac1c8ff22fb9"
		"ca-central-1" = "ami-071557fc8512776e8"
		"ap-east-1" = "ami-078671d3886607777"
		"ap-southeast-1" = "ami-08d0e50ba7d254215"
		"ap-southeast-2" = "ami-0a6620bacd75526e7"
		"us-east-1" = "ami-0fff59ba152714ea8"
		"us-east-2" = "ami-03e999fefe2dbd676"
		"us-west-1" = "ami-0adf667d45d267e48"
		"us-west-2" = "ami-09ce9a4771c05721b"
  }
}
