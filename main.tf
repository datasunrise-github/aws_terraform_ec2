...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0c86f9838921fb905"
		"eu-north-1" = "ami-0f30562970a486c4b"
		"ap-south-1" = "ami-08da8c1e1fedbcd84"
		"eu-west-3" = "ami-008cdca3bd182b3bd"
		"eu-west-2" = "ami-01bac03f9b47b25b5"
		"eu-west-1" = "ami-0e76826036830abf7"
		"ap-northeast-2" = "ami-04bea03cd55fc4302"
		"me-south-1" = "ami-08b56b862f2a5b6a3"
		"ap-northeast-1" = "ami-041b69dd32af5734b"
		"sa-east-1" = "ami-0b862434ce84d64b8"
		"ca-central-1" = "ami-0fa999bc8c0d7a43b"
		"ap-east-1" = "ami-0efd15c51f106b1ea"
		"ap-southeast-1" = "ami-022fc52cd36b5d5ec"
		"ap-southeast-2" = "ami-03ca4ab153a572f37"
		"us-east-1" = "ami-0bdb43fb0a5be4986"
		"us-east-2" = "ami-022855369396772cf"
		"us-west-1" = "ami-0ada471217a17f5fc"
		"us-west-2" = "ami-028232d7638eb2e80"
		"ap-south-2" = "ami-0751fba9cd74b2f5b"
		"eu-south-1" = "ami-019077f0f578b226f"
		"eu-south-2" = "ami-0c11fbfa804a9b4c3"
		"me-central-1" = "ami-0d14ec688db90b788"
		"il-central-1" = "ami-0d000695755c41b86"
		"eu-central-2" = "ami-0427c3b59dae7afd5"
		"af-south-1" = "ami-051ddf6bb1c3f6e3d"
		"ap-northeast-3" = "ami-0853e92e498e7674b"
		"ca-west-1" = "ami-004bc84a4dc55b2bf"
		"ap-southeast-3" = "ami-05699c33616156dca"
		"ap-southeast-4" = "ami-0dc77c39c369cf071"
  }
}
