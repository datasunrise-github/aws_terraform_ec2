...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0bc400d37ca3336e9"
		"eu-north-1" = "ami-081b0edc1f993b4b5"
		"ap-south-1" = "ami-09a52a4e70c28af85"
		"eu-west-3" = "ami-09cfbfcb87e9242dc"
		"eu-west-2" = "ami-0c8e45898c302b472"
		"eu-west-1" = "ami-028252dcd30af1e52"
		"ap-northeast-2" = "ami-01f47936873618146"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-02c9580ee33a20685"
		"sa-east-1" = "ami-02eae139a30cbc41e"
		"ca-central-1" = "ami-022fdd0d6956b102c"
		"ap-east-1" = "ami-0278693a39c3bd78d"
		"ap-southeast-1" = "ami-0121aaea04d5ec473"
		"ap-southeast-2" = "ami-0e1ccb34abcabd8c1"
		"us-east-1" = "ami-02f62bdfc953bd4a3"
		"us-east-2" = "ami-01c517b16b1694b4a"
		"us-west-1" = "ami-0e4cae6ca6a447a0f"
		"us-west-2" = "ami-0e828a1b769080f9e"
		"ap-south-2" = "ami-009f732c6dd6afcc8"
		"eu-south-1" = "ami-0505d6342cfd1152b"
		"eu-south-2" = "ami-04889a0263a725b55"
		"me-central-1" = "ami-0557b7b02d6d2984f"
		"il-central-1" = "ami-0ca8d2008e1d8b0ae"
		"eu-central-2" = "ami-0af2ae4ddc9c4d664"
		"af-south-1" = "ami-0350ab7f63cfda8b8"
		"ap-northeast-3" = "ami-0aa9a8b514d5e3b9c"
		"ca-west-1" = "ami-05d2b607cbedc5ab3"
		"ap-southeast-3" = "ami-0d039dacdfe7a823a"
		"ap-southeast-4" = "ami-0c32a0e317c3e2409"
  }
}
