...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0e20ffef4fca722af"
		"eu-north-1" = "ami-0f4f66dc6b3190031"
		"ap-south-1" = "ami-0c2e74bd149c94301"
		"eu-west-3" = "ami-04cb95a959d2e0b20"
		"eu-west-2" = "ami-0802c524bbef6fd1a"
		"eu-west-1" = "ami-0c3fe3da8bb08ea2a"
		"ap-northeast-2" = "ami-01a923acf9b33fff4"
		"me-south-1" = "ami-0b5efec53ef726504"
		"ap-northeast-1" = "ami-0cac8fcc3e61384bb"
		"sa-east-1" = "ami-050f0b55c67bc362b"
		"ca-central-1" = "ami-0b1bfb930af7a4103"
		"ap-east-1" = "ami-05df061caf6f44910"
		"ap-southeast-1" = "ami-026f0ad88262e0df8"
		"ap-southeast-2" = "ami-04a0775efdf617481"
		"us-east-1" = "ami-0d01e29a03c01bcc2"
		"us-east-2" = "ami-0765136318fd943dd"
		"us-west-1" = "ami-02eb3f5469c558d4b"
		"us-west-2" = "ami-05a87a4ecae509b7d"
  }
}
