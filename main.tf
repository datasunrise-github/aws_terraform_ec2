...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0b88fce9a7a06fefd"
		"eu-north-1" = "ami-0fffbd292573d21a4"
		"ap-south-1" = "ami-048fbde58c158b94f"
		"eu-west-3" = "ami-0bdbbcc1ea2f98d77"
		"eu-west-2" = "ami-058bdd97d625b744e"
		"eu-west-1" = "ami-0d93b2cda866b58d2"
		"ap-northeast-2" = "ami-0b2dc6476374f8bea"
		"me-south-1" = "ami-0edaf08cddd095472"
		"ap-northeast-1" = "ami-0ac7bab3f0db0ab68"
		"sa-east-1" = "ami-0360881cd9d8c2f10"
		"ca-central-1" = "ami-07a91e300acbdf0e5"
		"ap-east-1" = "ami-06672516df9e8b06c"
		"ap-southeast-1" = "ami-0cc4cb99e2272d661"
		"ap-southeast-2" = "ami-0ac13dd3304095a86"
		"us-east-1" = "ami-0801d26ace2ae681a"
		"us-east-2" = "ami-0dc60eecb8652fe09"
		"us-west-1" = "ami-0e67156173c0c615d"
		"us-west-2" = "ami-0be95babc49e6ac52"
  }
}
