...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-03f18d3fc69ad4233"
		"eu-north-1" = "ami-0690c56e2631d5e4d"
		"ap-south-1" = "ami-056773f5196a1984a"
		"eu-west-3" = "ami-0e53ced8c976f00c2"
		"eu-west-2" = "ami-06b8ec3fa19b5682c"
		"eu-west-1" = "ami-027ca67a9280af7e8"
		"ap-northeast-2" = "ami-0204f612937dbe138"
		"me-south-1" = "ami-02bd4c5c052aec16d"
		"ap-northeast-1" = "ami-0e9d92a5eb998d87d"
		"sa-east-1" = "ami-003c18bc1b900a29e"
		"ca-central-1" = "ami-0116b25a8878b59f3"
		"ap-east-1" = "ami-014d7e3f822d1fe91"
		"ap-southeast-1" = "ami-076bf43f0fa07ddb2"
		"ap-southeast-2" = "ami-0a39f09d95d1fa6df"
		"us-east-1" = "ami-035662798ab0f860a"
		"us-east-2" = "ami-0328ddef705441c94"
		"us-west-1" = "ami-0a49da24995a57278"
		"us-west-2" = "ami-0ba987107f0169a7c"
  }
}
