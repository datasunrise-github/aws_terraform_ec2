...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0e59fe7cd382ceb25"
		"eu-north-1" = "ami-032ec309a1f120fbe"
		"ap-south-1" = "ami-0d06327d0681172e1"
		"eu-west-3" = "ami-013d1d39da74f95d5"
		"eu-west-2" = "ami-0846b19c0d36c85f1"
		"eu-west-1" = "ami-0acd63f1803db618e"
		"ap-northeast-2" = "ami-0e8e03227009dd6c5"
		"me-south-1" = "ami-0e357c4371ecfff7b"
		"ap-northeast-1" = "ami-031435afe2d5e84b6"
		"sa-east-1" = "ami-0c2cef64e822d8bd3"
		"ca-central-1" = "ami-0b98382b1f75b7da5"
		"ap-east-1" = "ami-0ecfb4355d1b9cdd5"
		"ap-southeast-1" = "ami-00a4226699c80d8fb"
		"ap-southeast-2" = "ami-08cadf212db554d19"
		"us-east-1" = "ami-04840100d821a7da1"
		"us-east-2" = "ami-0b4dd7843101a66b2"
		"us-west-1" = "ami-09e5d186df5d03cc8"
		"us-west-2" = "ami-06edd09354a9f3475"
		"ap-south-2" = "ami-09d6a7148736a4d0b"
		"eu-south-1" = "ami-04d631c7ed3371e13"
		"eu-south-2" = "ami-025cbffc814e23200"
		"me-central-1" = "ami-01824f4ca13125151"
		"il-central-1" = "ami-0865f5eca8fda047c"
		"eu-central-2" = "ami-06ab5f8272d0c28a6"
		"af-south-1" = "ami-0ba0c4410117a361f"
		"ap-northeast-3" = "ami-03d3d185c4f4a8e59"
		"ca-west-1" = "ami-0f8ed109de6e13ff1"
		"ap-southeast-3" = "ami-0930097a8499d3891"
		"ap-southeast-4" = "ami-010090ee25beeec93"
  }
}
