...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01f40e57a0cdeb332"
		"eu-north-1" = "ami-0b94430c4f59c9dbd"
		"ap-south-1" = "ami-08eaafce71215aba8"
		"eu-west-3" = "ami-041f324fd55b054c2"
		"eu-west-2" = "ami-09405ff14764178b9"
		"eu-west-1" = "ami-022f79238e787f29c"
		"ap-northeast-2" = "ami-01c7c26a4992ee15c"
		"me-south-1" = "ami-0aed0fae7202afb1f"
		"ap-northeast-1" = "ami-0aaaf61a37e8d85b9"
		"sa-east-1" = "ami-032de8812dd900062"
		"ca-central-1" = "ami-0c5baa909446a5a67"
		"ap-east-1" = "ami-0d79cb8b715e1f43f"
		"ap-southeast-1" = "ami-0916adf3094bdd48e"
		"ap-southeast-2" = "ami-0a98a5b18354ffe8d"
		"us-east-1" = "ami-03f75004b6ca4d94c"
		"us-east-2" = "ami-03b618cc8412f2cd1"
		"us-west-1" = "ami-044b6aab494b6e3f7"
		"us-west-2" = "ami-0e21db0904e1bfb85"
		"ap-south-2" = "ami-0172cc6ef33d0e000"
		"eu-south-1" = "ami-0e92558f7e8170f7f"
		"eu-south-2" = "ami-07efcc591977e1ea3"
		"me-central-1" = "ami-0d28050ece89d4076"
		"il-central-1" = "ami-0c879a665f224df28"
		"eu-central-2" = "ami-004ea8b2725428be3"
		"af-south-1" = "ami-0fdea43dbdd5760f7"
		"ap-northeast-3" = "ami-0f84c6fff118ac492"
		"ca-west-1" = "ami-07de4c217a5bbce8a"
		"ap-southeast-3" = "ami-0462cfb417aa5cad4"
		"ap-southeast-4" = "ami-030fca63ac2bd3c7f"
  }
}
