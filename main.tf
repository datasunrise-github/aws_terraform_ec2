...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0cddcf6f4a686a122"
		"eu-north-1" = "ami-0fdd2672daf740a06"
		"ap-south-1" = "ami-04d829384bc3f08ab"
		"eu-west-3" = "ami-08cde0bc1531ef57f"
		"eu-west-2" = "ami-05b86aef26d15aac7"
		"eu-west-1" = "ami-0b3d2546f3614527f"
		"ap-northeast-2" = "ami-0af2ef48b795db034"
		"me-south-1" = "ami-0203c942db3118eee"
		"ap-northeast-1" = "ami-0ce8fc4e24de5afd3"
		"sa-east-1" = "ami-030c0e3e0e69d9969"
		"ca-central-1" = "ami-04c1082b5795bf1a8"
		"ap-east-1" = "ami-0de02fbf3c785bd9b"
		"ap-southeast-1" = "ami-009eebe17cc0ce3a4"
		"ap-southeast-2" = "ami-01469cab80f8c49b1"
		"us-east-1" = "ami-0ece5eeddc293284a"
		"us-east-2" = "ami-021f6d5c15a249fda"
		"us-west-1" = "ami-0ff8136691adbcb98"
		"us-west-2" = "ami-0b8397662a140f3c6"
		"ap-south-2" = "ami-0ce8478583bdee91e"
		"eu-south-1" = "ami-0bf0ba1a5d66245fa"
		"eu-south-2" = "ami-03e5969f8893ed861"
		"me-central-1" = "ami-0dcf45e8db8475d74"
		"il-central-1" = "ami-0b8bb294c6ef6e130"
		"eu-central-2" = "ami-0cd32b83b39e87efd"
		"af-south-1" = "ami-02dc5eab92280c724"
		"ap-northeast-3" = "ami-05e030e2c4d3a1858"
		"ca-west-1" = "ami-07a74617ddad23554"
		"ap-southeast-3" = "ami-0f324f8179c99030f"
		"ap-southeast-4" = "ami-0d1fb0080c2c1fb65"
  }
}
