...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-04b843084d2818a87"
		"eu-north-1" = "ami-0a0ca3edb4055af8f"
		"ap-south-1" = "ami-0987dac86c16c6bb9"
		"eu-west-3" = "ami-05d9738abe7405804"
		"eu-west-2" = "ami-066b44d369a9db6ba"
		"eu-west-1" = "ami-0bc98bf59bf275a01"
		"ap-northeast-2" = "ami-08f43337c392a17c8"
		"me-south-1" = "ami-08d2b0f04dfec4b16"
		"ap-northeast-1" = "ami-0e8a1c9555a1adbc4"
		"sa-east-1" = "ami-0c1c54f1380526559"
		"ca-central-1" = "ami-05c499834346910a3"
		"ap-east-1" = "ami-00108204cb27ba1cf"
		"ap-southeast-1" = "ami-0a0ad59427ff0d61e"
		"ap-southeast-2" = "ami-0555ffd05230e3652"
		"us-east-1" = "ami-0cc43702ab57baeb7"
		"us-east-2" = "ami-09120e29edf8c1b09"
		"us-west-1" = "ami-0754dbb281930f9fb"
		"us-west-2" = "ami-0fbd2a44e444e7ccd"
  }
}
