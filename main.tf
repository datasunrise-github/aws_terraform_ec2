...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-00cce7672d6501652"
		"eu-north-1" = "ami-0b159eedb4e186a30"
		"ap-south-1" = "ami-098b6ba3a52f153f6"
		"eu-west-3" = "ami-02587af466e599289"
		"eu-west-2" = "ami-085dbe3f76024db66"
		"eu-west-1" = "ami-070ee63a19c950295"
		"ap-northeast-2" = "ami-0456dc0d01f962436"
		"me-south-1" = "ami-0ed90b0df6f5b09c6"
		"ap-northeast-1" = "ami-0ffa03b92e77efead"
		"sa-east-1" = "ami-0312840becbca49cd"
		"ca-central-1" = "ami-01050177e6d9d3e87"
		"ap-east-1" = "ami-08c9cf7468709d269"
		"ap-southeast-1" = "ami-00e8ecb6065d05af6"
		"ap-southeast-2" = "ami-0a6cce0c950813c3d"
		"us-east-1" = "ami-0b0f0fa93b8b2ce9d"
		"us-east-2" = "ami-07311e6da6f304adc"
		"us-west-1" = "ami-01c255b8638821827"
		"us-west-2" = "ami-069ce032f7163205c"
  }
}
