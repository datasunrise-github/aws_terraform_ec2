...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0be620176cd88243a"
		"eu-north-1" = "ami-0648b7d24b565bef7"
		"ap-south-1" = "ami-0e0b4ec0c53baae3c"
		"eu-west-3" = "ami-06357c1c4f681d65b"
		"eu-west-2" = "ami-0ef62aa4240334bfe"
		"eu-west-1" = "ami-07d21604d2b351fe6"
		"ap-northeast-2" = "ami-095ed9cc9ea92c894"
		"me-south-1" = "ami-04c3b4425131dad6f"
		"ap-northeast-1" = "ami-08d7b2f4ec53ed1d4"
		"sa-east-1" = "ami-0932b79c411b14f1c"
		"ca-central-1" = "ami-07b4147b6a47ec6a9"
		"ap-east-1" = "ami-09a28b409535d8ac6"
		"ap-southeast-1" = "ami-0cd7b986bb93f73fc"
		"ap-southeast-2" = "ami-06384d39449647a4f"
		"us-east-1" = "ami-08dc62169bd627d73"
		"us-east-2" = "ami-0ac8f5873e214955d"
		"us-west-1" = "ami-092f33312b4779677"
		"us-west-2" = "ami-0f003aa01918f7082"
		"ap-south-2" = "ami-014ddff33ae443e5f"
		"eu-south-1" = "ami-039eb9c55d5b55765"
		"eu-south-2" = "ami-0455ec186463909eb"
		"me-central-1" = "ami-092897fb8b937c615"
		"il-central-1" = "ami-0c556a19bd9cf7a28"
		"eu-central-2" = "ami-00a0e7f71e4c848aa"
		"af-south-1" = "ami-04a09811b9df12c40"
		"ap-northeast-3" = "ami-0727c93ce67d08a49"
		"ca-west-1" = "ami-0f8f675621374a5b9"
		"ap-southeast-3" = "ami-0c9a7e23b6607ef06"
		"ap-southeast-4" = "ami-03fb15a6c1992da70"
  }
}
