...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01d65bfb651a965a5"
		"eu-north-1" = "ami-035d884cb958fd481"
		"ap-south-1" = "ami-075c6fb29fe2a9cb5"
		"eu-west-3" = "ami-01b12f12040be0c7c"
		"eu-west-2" = "ami-0a2c7a2a497ebb4db"
		"eu-west-1" = "ami-06a37c7affab80b95"
		"ap-northeast-2" = "ami-042f141c0dc38a768"
		"me-south-1" = "ami-01f110f2fec066084"
		"ap-northeast-1" = "ami-0839cfd202679040f"
		"sa-east-1" = "ami-00554d8c2a67e23b0"
		"ca-central-1" = "ami-03589f6ff1e732abc"
		"ap-east-1" = "ami-0138f00af210b2331"
		"ap-southeast-1" = "ami-0e9bb01d9aff89836"
		"ap-southeast-2" = "ami-08c1e3dd5de82432c"
		"us-east-1" = "ami-0d374983bc2477db2"
		"us-east-2" = "ami-089f4406fbfdac117"
		"us-west-1" = "ami-0c5bf9da7af6b2bce"
		"us-west-2" = "ami-06fc000813aca4098"
		"ap-south-2" = "ami-0eeca6c76b4416b89"
		"eu-south-1" = "ami-0d90d44b3096521f2"
		"eu-south-2" = "ami-08a14b087e4a83da0"
		"me-central-1" = "ami-0be750bcaf8358836"
		"il-central-1" = "ami-042edd0505c081d51"
		"eu-central-2" = "ami-062820e22f489f78e"
		"af-south-1" = "ami-0c8af97dc4e2e32a3"
		"ap-northeast-3" = "ami-001c11b5235c5b82f"
		"ca-west-1" = "ami-06e272bd1ba5990ea"
		"ap-southeast-3" = "ami-0256033cdccd8974f"
		"ap-southeast-4" = "ami-08e8222767e7f83ca"
  }
}
