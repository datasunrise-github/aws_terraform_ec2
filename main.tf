...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-08f4650200e85f6b2"
		"eu-north-1" = "ami-0e31fa8cf3e037ef9"
		"ap-south-1" = "ami-0f74d02731e9ecf52"
		"eu-west-3" = "ami-08b062fe2da5143ea"
		"eu-west-2" = "ami-045d1e99dcbbf280e"
		"eu-west-1" = "ami-0c151d70a20d30ac3"
		"ap-northeast-2" = "ami-057a99a09bda80e7a"
		"me-south-1" = "ami-00b41bffb648fa4a8"
		"ap-northeast-1" = "ami-0853a0c3f77a49754"
		"sa-east-1" = "ami-0d174e034071c2402"
		"ca-central-1" = "ami-017859cd565b50f56"
		"ap-east-1" = "ami-0a9eec69b07ec41b2"
		"ap-southeast-1" = "ami-05327924fec989d9d"
		"ap-southeast-2" = "ami-0b1d53efa0fe3fc4c"
		"us-east-1" = "ami-0b9d9355a71b8d80f"
		"us-east-2" = "ami-08e8b335c0bb26dce"
		"us-west-1" = "ami-06536f4e5d659285b"
		"us-west-2" = "ami-0200344351777b054"
  }
}
