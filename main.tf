...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-03cae175d6b873dc9"
		"eu-north-1" = "ami-0183483ab45dbb832"
		"ap-south-1" = "ami-06d4ee0045e3508ce"
		"eu-west-3" = "ami-050f4d85546a2c87b"
		"eu-west-2" = "ami-0c0be32aad6139f2c"
		"eu-west-1" = "ami-0921fcea2ae8c4ed4"
		"ap-northeast-2" = "ami-04c8d5e401242aba4"
		"me-south-1" = "ami-017955a8e968753b6"
		"ap-northeast-1" = "ami-05668d27db72301d1"
		"sa-east-1" = "ami-0bc41a4a42dc7d04f"
		"ca-central-1" = "ami-031abd80450f8d449"
		"ap-east-1" = "ami-0b16415ddebc3cfe4"
		"ap-southeast-1" = "ami-0d3ba305f2d500bfc"
		"ap-southeast-2" = "ami-055c466a9351b6df9"
		"us-east-1" = "ami-06bec892d124be36b"
		"us-east-2" = "ami-0f8a437ff18ee5b0e"
		"us-west-1" = "ami-00a0ba07824fd15f0"
		"us-west-2" = "ami-051a5c899af7b1c55"
		"ap-south-2" = "ami-047a0911fd8edb201"
		"eu-south-1" = "ami-0c58ec28c88ddece8"
		"eu-south-2" = "ami-0e3bf6d88cd252730"
		"me-central-1" = "ami-0743106a6b2f6489e"
		"il-central-1" = "ami-0075873f870b5b55b"
		"eu-central-2" = "ami-0146845c74acc6bc0"
		"af-south-1" = "ami-0a1ce9710cd53f8bd"
		"ap-northeast-3" = "ami-051bc4643f0cb4e9a"
		"ca-west-1" = "ami-01dc02d7957434281"
		"ap-southeast-3" = "ami-0428698201545072b"
		"ap-southeast-4" = "ami-08d717918e31f7fe1"
  }
}
