...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0320213c515334359"
		"eu-north-1" = "ami-02309fe8083d7e6ed"
		"ap-south-1" = "ami-05ac7ad49fe2a79c2"
		"eu-west-3" = "ami-0ac5a6033458f1b8c"
		"eu-west-2" = "ami-0b614f974d5a19bdc"
		"eu-west-1" = "ami-08d71bf4309e3b724"
		"ap-northeast-2" = "ami-0285ac3313d7279d0"
		"me-south-1" = "ami-0eb6cb825b683fffd"
		"ap-northeast-1" = "ami-0bd8f73bbfcae03da"
		"sa-east-1" = "ami-07fdaefcaed41a6ef"
		"ca-central-1" = "ami-0ff419dbaf6521e78"
		"ap-east-1" = "ami-0a9c4917051312dd0"
		"ap-southeast-1" = "ami-0e00f4f9d1676992e"
		"ap-southeast-2" = "ami-0a91bc90fc65a0a63"
		"us-east-1" = "ami-057be4236c67428ff"
		"us-east-2" = "ami-04df5a78460c927c0"
		"us-west-1" = "ami-03f889e524600e779"
		"us-west-2" = "ami-05cec14ddb0a8f45f"
		"ap-south-2" = "ami-06d97de74f6d019c3"
		"eu-south-1" = "ami-089ea204a22407152"
		"eu-south-2" = "ami-04e5bc34e718ecb19"
		"me-central-1" = "ami-098ff27627f25f587"
		"il-central-1" = "ami-01f90ab3c9f6908a2"
		"eu-central-2" = "ami-018f1be9598306b94"
		"af-south-1" = "ami-0cdfd065f0231ad56"
		"ap-northeast-3" = "ami-04444ba267773ea34"
		"ca-west-1" = "ami-0c60af311a2803b1c"
		"ap-southeast-3" = "ami-0902109af46b8cc39"
		"ap-southeast-4" = "ami-0a0b026a0ec3f81a3"
  }
}
