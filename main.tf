...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0ad496513d774fc71"
		"eu-north-1" = "ami-082199211bdf5f535"
		"ap-south-1" = "ami-0288908645c0c7520"
		"eu-west-3" = "ami-0f76ad5725a61c33a"
		"eu-west-2" = "ami-086eae5d71377d3eb"
		"eu-west-1" = "ami-0228a1692ffc0898a"
		"ap-northeast-2" = "ami-0ef20642e6e4adde3"
		"me-south-1" = "ami-01dd2b123bde7c95e"
		"ap-northeast-1" = "ami-0b04748782326299a"
		"sa-east-1" = "ami-0aa7d8d737faf1c97"
		"ca-central-1" = "ami-045dc36a871648689"
		"ap-east-1" = "ami-017f1f6bff263008f"
		"ap-southeast-1" = "ami-01df3d80ca87596a8"
		"ap-southeast-2" = "ami-0e6952a54475f088b"
		"us-east-1" = "ami-09919dfe1a89f8080"
		"us-east-2" = "ami-0444e059024482618"
		"us-west-1" = "ami-0c7ae1132fe6d87de"
		"us-west-2" = "ami-077b2c1a2547c1173"
		"ap-south-2" = "ami-0af25e3da74124102"
		"eu-south-1" = "ami-01d6eeb347b78b3c3"
		"eu-south-2" = "ami-0ef1ba9b4822ca456"
		"me-central-1" = "ami-0247bb284d86e2ec6"
		"il-central-1" = "ami-0ca710fcd9a0e769e"
		"eu-central-2" = "ami-075045fe9f2f36dfa"
		"af-south-1" = "ami-092ffdb855e98f23d"
		"ap-northeast-3" = "ami-09f190a154616ea14"
		"ca-west-1" = "ami-00c2b9d9a8329580b"
		"ap-southeast-3" = "ami-02e81d809d79c5762"
		"ap-southeast-4" = "ami-039e827bb1ad095a1"
  }
}
