...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0d5f1f0e8777b4dc1"
		"eu-north-1" = "ami-02c44b927b4cb8d46"
		"ap-south-1" = "ami-077706b4e6cac5393"
		"eu-west-3" = "ami-09726b382a92807ad"
		"eu-west-2" = "ami-0a1da38de90bd854b"
		"eu-west-1" = "ami-09d18164ccf9a6045"
		"ap-northeast-2" = "ami-01d9efd8869d474bc"
		"me-south-1" = "ami-0540cfd491325e9fb"
		"ap-northeast-1" = "ami-0a9f2009e23c8e0bd"
		"sa-east-1" = "ami-02d833ef5645a1f8c"
		"ca-central-1" = "ami-063669716f105add0"
		"ap-east-1" = "ami-07d62f8be71944686"
		"ap-southeast-1" = "ami-07b5c12db8c64268d"
		"ap-southeast-2" = "ami-06a2a4fda5d2618f2"
		"us-east-1" = "ami-033dadf19f66436d6"
		"us-east-2" = "ami-0cbfe7ae817265556"
		"us-west-1" = "ami-026135e3b87c3eb6f"
		"us-west-2" = "ami-069ffd088358bded3"
		"ap-south-2" = "ami-09677acda9e845892"
		"eu-south-1" = "ami-0488d49eb63308ca0"
		"eu-south-2" = "ami-01fe2915274bc5eed"
		"me-central-1" = "ami-037f226e698eb968d"
		"il-central-1" = "ami-059c0215342f2e2c5"
		"eu-central-2" = "ami-07359440f5c61fcfc"
		"af-south-1" = "ami-01349309a6943091f"
		"ap-northeast-3" = "ami-0ab2ade88b9649ea7"
		"ca-west-1" = "ami-054d3ef5ebf88038a"
		"ap-southeast-3" = "ami-043887aaf85226339"
		"ap-southeast-4" = "ami-0cd6651140bd0cba9"
  }
}
