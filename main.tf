...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0d5e9d470286bb842"
		"eu-north-1" = "ami-0bde51c6beae4fccc"
		"ap-south-1" = "ami-01b0d252246d54259"
		"eu-west-3" = "ami-0aa1856800f39d6a4"
		"eu-west-2" = "ami-02f7b6d7373bf4c76"
		"eu-west-1" = "ami-02236790942d022d0"
		"ap-northeast-2" = "ami-08779ae44ba4cc4a5"
		"me-south-1" = "ami-01b77d4cf2d23424b"
		"ap-northeast-1" = "ami-07e3b80d3fc6f2254"
		"sa-east-1" = "ami-0d12d15970af201d3"
		"ca-central-1" = "ami-03c95da8cfa5b34b8"
		"ap-east-1" = "ami-078ca56d2e75c16cb"
		"ap-southeast-1" = "ami-03578f6a0b203b6fd"
		"ap-southeast-2" = "ami-0f4a25611b3dcb2e0"
		"us-east-1" = "ami-0e00da4fa1215b6f3"
		"us-east-2" = "ami-0f38f6ddf125a607a"
		"us-west-1" = "ami-0eb6ef9a43d2e0da3"
		"us-west-2" = "ami-0ee58bba746148fc6"
		"ap-south-2" = "ami-0b72485aa34b30e1f"
		"eu-south-1" = "ami-0505dcf6a4c657562"
		"eu-south-2" = "ami-0e8d841768c63833d"
		"me-central-1" = "ami-0bbf991ec5fb8d2f1"
		"il-central-1" = "ami-0c3b5c260997be515"
		"eu-central-2" = "ami-0363408f8edb9f12b"
		"af-south-1" = "ami-081720b2cc7b275c1"
		"ap-northeast-3" = "ami-08f546b4bf263e08a"
		"ca-west-1" = "ami-04205527ae0ba2b78"
		"ap-southeast-3" = "ami-026d23d0984778987"
		"ap-southeast-4" = "ami-0888e45b5097d8636"
  }
}
