...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0c67a8456ecc2996a"
		"eu-north-1" = "ami-01c862fd8d9347c10"
		"ap-south-1" = "ami-0756811cf65c573f9"
		"eu-west-3" = "ami-098b0450bc7895b01"
		"eu-west-2" = "ami-0dac29546f54dbd88"
		"eu-west-1" = "ami-051f42ec8ca4e5abc"
		"ap-northeast-2" = "ami-0e10314d1beaf7906"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0c8b97783035ed560"
		"sa-east-1" = "ami-0db036312ea581b54"
		"ca-central-1" = "ami-01d7e18321620acb4"
		"ap-east-1" = "ami-0ef2312661e7dd498"
		"ap-southeast-1" = "ami-0ac51d29e695fbcac"
		"ap-southeast-2" = "ami-0e8bd370d58b25093"
		"us-east-1" = "ami-0bd4260a46227a300"
		"us-east-2" = "ami-0c3834cae49ccd11d"
		"us-west-1" = "ami-004fd2144a75e7a45"
		"us-west-2" = "ami-0e6b8377efee20d3a"
		"ap-south-2" = "ami-08a02498c5768c829"
		"eu-south-1" = "ami-04410f0529d965483"
		"eu-south-2" = "ami-02c1576dd144d6080"
		"me-central-1" = "ami-082c084928d4e4976"
		"il-central-1" = "ami-0c5b2fb6196c90d34"
		"eu-central-2" = "ami-09922bd90ffd2ab1e"
		"af-south-1" = "ami-0338c5a9112b0451c"
		"ap-northeast-3" = "ami-0426e6c28bac500b2"
		"ca-west-1" = "ami-07b1dd8e24d7386b0"
		"ap-southeast-3" = "ami-0d944a57857a440a5"
		"ap-southeast-4" = "ami-06b80fc40e75e348d"
  }
}
