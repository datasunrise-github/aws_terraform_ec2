...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0692a6ca5c1af7fb9"
		"eu-north-1" = "ami-082607123dfc3337e"
		"ap-south-1" = "ami-047c96dd86a0c7c67"
		"eu-west-3" = "ami-0d9b8f92b1a83fe72"
		"eu-west-2" = "ami-0d453bb723161398a"
		"eu-west-1" = "ami-0cbfe9423a3a4cb4d"
		"ap-northeast-2" = "ami-00c8fc41ab30655f8"
		"me-south-1" = "ami-0498e18e55a3dd1ad"
		"ap-northeast-1" = "ami-042f065ce3bb8a0ab"
		"sa-east-1" = "ami-0746da72a809adfbf"
		"ca-central-1" = "ami-0ed4da9240b170616"
		"ap-east-1" = "ami-062a09cba8aa70e65"
		"ap-southeast-1" = "ami-0a21fa1d364beea42"
		"ap-southeast-2" = "ami-07f1f7c1f5403e583"
		"us-east-1" = "ami-02ebcfa7847ef32f1"
		"us-east-2" = "ami-07495251148a582f7"
		"us-west-1" = "ami-0fb0a269e5e4857a7"
		"us-west-2" = "ami-0b0e091783f50d3ff"
  }
}
