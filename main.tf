...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0a5b71f26fd8cada0"
		"eu-north-1" = "ami-057036803ed85155a"
		"ap-south-1" = "ami-0170934967f138daa"
		"eu-west-3" = "ami-09ac1720300fc811a"
		"eu-west-2" = "ami-0d1a28ec0801408b6"
		"eu-west-1" = "ami-0376f4b7a1a6eecdd"
		"ap-northeast-2" = "ami-07c8366cb5a6995d1"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-06f0c52f01820302e"
		"sa-east-1" = "ami-079356af52f6dd604"
		"ca-central-1" = "ami-03d8202c653cfb966"
		"ap-east-1" = "ami-0a3675f76fae8f2e5"
		"ap-southeast-1" = "ami-02f57766c63aaa2f8"
		"ap-southeast-2" = "ami-030f9264b8a72b3d0"
		"us-east-1" = "ami-0ea348c3cc9489b59"
		"us-east-2" = "ami-0df156c47a1d201a2"
		"us-west-1" = "ami-0e336ca038e0e6ddf"
		"us-west-2" = "ami-08dba0436480e5471"
		"ap-south-2" = "ami-010606d130e843231"
		"eu-south-1" = "ami-0ba18ed72ae279401"
		"eu-south-2" = "ami-06576ca67ec6677ee"
		"me-central-1" = "ami-0c12023dd6de56f40"
		"il-central-1" = "ami-02f36b38a65c063ec"
		"eu-central-2" = "ami-0e323fffa6ff7d755"
		"af-south-1" = "ami-04db222cb63fb63eb"
		"ap-northeast-3" = "ami-059b315d6741b1657"
		"ca-west-1" = "ami-055d2bc1e6399c87b"
		"ap-southeast-3" = "ami-08cd9c57050502aad"
		"ap-southeast-4" = "ami-022bc12a929e90c44"
  }
}
