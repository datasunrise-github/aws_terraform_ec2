...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01ea5129599f9c792"
		"eu-north-1" = "ami-02036481b43b61179"
		"ap-south-1" = "ami-065e9fa86aac16cfc"
		"eu-west-3" = "ami-0fcf1536c3d1a4f99"
		"eu-west-2" = "ami-0d203484687276bab"
		"eu-west-1" = "ami-01161f8b0e62c62e6"
		"ap-northeast-2" = "ami-0e517782c04391135"
		"me-south-1" = "ami-08335f46423b88a0d"
		"ap-northeast-1" = "ami-0298920616106c867"
		"sa-east-1" = "ami-0c6cc7526ee6dfc95"
		"ca-central-1" = "ami-0d6c920ef4ce11b3a"
		"ap-east-1" = "ami-0f8375c66ba4817bf"
		"ap-southeast-1" = "ami-0ef3b67774f73334c"
		"ap-southeast-2" = "ami-0f91d8055a3689cb0"
		"us-east-1" = "ami-0ae429ac184b5a805"
		"us-east-2" = "ami-0e253e6f13594dd4f"
		"us-west-1" = "ami-07ba9b53968d2f4cd"
		"us-west-2" = "ami-0e310600acce7e3dd"
		"ap-south-2" = "ami-01a852bad5790e0f4"
		"eu-south-1" = "ami-00719a417bf4d36cd"
		"eu-south-2" = "ami-009472a158b8238ec"
		"me-central-1" = "ami-0860b267c96f989f0"
		"il-central-1" = "ami-02a04560f1647d3a6"
		"eu-central-2" = "ami-0091a2ce74598a482"
		"af-south-1" = "ami-067f1a38337d20ebe"
		"ap-northeast-3" = "ami-0fb81a2213c52ce4c"
		"ca-west-1" = "ami-01f08d3fc068ebf31"
		"ap-southeast-3" = "ami-07a4d5a02627eeeab"
		"ap-southeast-4" = "ami-01819daef692b2043"
  }
}
