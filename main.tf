...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-091511dc649d26be6"
		"eu-north-1" = "ami-061e6a0ebc2486362"
		"ap-south-1" = "ami-0b0238d99a5666edc"
		"eu-west-3" = "ami-0851845c490dce85e"
		"eu-west-2" = "ami-0d0fd0137a5bd97c1"
		"eu-west-1" = "ami-0ec5cb910b94de227"
		"ap-northeast-2" = "ami-013d87a44ad7165a1"
		"me-south-1" = "ami-0fa677e7d105a565c"
		"ap-northeast-1" = "ami-063fea2f6d66bb924"
		"sa-east-1" = "ami-07c2f32ebbc661d47"
		"ca-central-1" = "ami-0b6d1c92f606be846"
		"ap-east-1" = "ami-0f95c215df61e4b7d"
		"ap-southeast-1" = "ami-0b20eda06721b7f4b"
		"ap-southeast-2" = "ami-07636550d044899d6"
		"us-east-1" = "ami-00bb97bc18c0c9611"
		"us-east-2" = "ami-0ef5ec6cc31d806e4"
		"us-west-1" = "ami-070075ef37b47546b"
		"us-west-2" = "ami-092f44d4abaf897a6"
		"ap-south-2" = "ami-054771ef998d738b5"
		"eu-south-1" = "ami-09be3b61c024991a6"
		"eu-south-2" = "ami-0066658273102b9ed"
		"me-central-1" = "ami-005b57d5e45fb3bd1"
		"il-central-1" = "ami-052e2ecc7b83f2533"
		"eu-central-2" = "ami-0902ca8cb16eaf6c7"
		"af-south-1" = "ami-0b967fdfb4e24c814"
		"ap-northeast-3" = "ami-0da6ce224ab8f7c2e"
		"ca-west-1" = "ami-03248295b0e0e1b1f"
		"ap-southeast-3" = "ami-04422e84508080b14"
		"ap-southeast-4" = "ami-08eddf4eed6c9b167"
  }
}
