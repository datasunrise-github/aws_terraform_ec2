...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-021ac66b61c3b82c4"
		"eu-north-1" = "ami-03923fdfb1b0ce23c"
		"ap-south-1" = "ami-0db85bb3efd7131d9"
		"eu-west-3" = "ami-0115b438e2cbc6e9d"
		"eu-west-2" = "ami-08e05e0e7b663de64"
		"eu-west-1" = "ami-0b7a0523bdb1382d9"
		"ap-northeast-2" = "ami-028dc3e92979f7583"
		"me-south-1" = "ami-0ca3f284ada32aa8a"
		"ap-northeast-1" = "ami-054cd96da086e5ef1"
		"sa-east-1" = "ami-02d6687e0ecb1441f"
		"ca-central-1" = "ami-06f63a634d49e5cca"
		"ap-east-1" = "ami-0808ed3065f4af15b"
		"ap-southeast-1" = "ami-00940cd64e161d4aa"
		"ap-southeast-2" = "ami-0dec1fb54bed28b56"
		"us-east-1" = "ami-09a04094e4ae6dde3"
		"us-east-2" = "ami-0a2a826c77c3d2c9f"
		"us-west-1" = "ami-00207e085db260a64"
		"us-west-2" = "ami-0dd2d9b64d20687c4"
  }
}
