...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0477f622149d5387b"
		"eu-north-1" = "ami-098fb2710a303ee1a"
		"ap-south-1" = "ami-06aa5a7d621e2afd8"
		"eu-west-3" = "ami-0947debe4faf6e5c4"
		"eu-west-2" = "ami-05058c6c95a30a032"
		"eu-west-1" = "ami-03d052f0836c6ad9f"
		"ap-northeast-2" = "ami-071a29bcd27e8341a"
		"me-south-1" = "ami-0b5e34b4bcf132143"
		"ap-northeast-1" = "ami-00edeef502c8f4423"
		"sa-east-1" = "ami-02f9aad14447028c6"
		"ca-central-1" = "ami-0fe9cef0b342071cc"
		"ap-east-1" = "ami-031feab924cc77444"
		"ap-southeast-1" = "ami-09f677d82bddef8a9"
		"ap-southeast-2" = "ami-0ae29044552ffb650"
		"us-east-1" = "ami-05f917e0d5a081731"
		"us-east-2" = "ami-0bce314aabd069723"
		"us-west-1" = "ami-080fbdaf39508cf60"
		"us-west-2" = "ami-09f02de53834097f4"
		"ap-south-2" = "ami-08b4655e46260a7c1"
		"eu-south-1" = "ami-0ff00217c2ea8a6de"
		"eu-south-2" = "ami-0d7f6f0e2c2371e6f"
		"me-central-1" = "ami-0e2359e7971eefa27"
		"il-central-1" = "ami-038b9b71ca2d657f0"
		"eu-central-2" = "ami-022993f74bc2d7793"
		"af-south-1" = "ami-0fdbdf7df447322ba"
		"ap-northeast-3" = "ami-011d45874e706ad3a"
		"ca-west-1" = "ami-0225ebb1dbed2089d"
		"ap-southeast-3" = "ami-02628911e2362dddb"
		"ap-southeast-4" = "ami-0525aea89b0e34dc6"
  }
}
