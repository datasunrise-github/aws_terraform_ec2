...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0f61023b1f69f1a02"
		"eu-north-1" = "ami-0ce64b5c3345417a2"
		"ap-south-1" = "ami-079648459c577ffbe"
		"eu-west-3" = "ami-0e661469227bfcfff"
		"eu-west-2" = "ami-07a0b7d62dd86faac"
		"eu-west-1" = "ami-0e6d0c483e47c64f8"
		"ap-northeast-2" = "ami-0a2a9ef04f46bca7c"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0ac4a0539f17caaa7"
		"sa-east-1" = "ami-07718a1998bfcbbef"
		"ca-central-1" = "ami-0462990863e1eec8b"
		"ap-east-1" = "ami-021380c480c5be477"
		"ap-southeast-1" = "ami-054b71aefcad9e12e"
		"ap-southeast-2" = "ami-08625ead9f95404e6"
		"us-east-1" = "ami-0b2f7d2a32977d4db"
		"us-east-2" = "ami-09089b43a6b6a2d24"
		"us-west-1" = "ami-01437096bf0175d8f"
		"us-west-2" = "ami-02f6734dc356bca3a"
		"ap-south-2" = "ami-02016064fea87b6b0"
		"eu-south-1" = "ami-0ac75b65cbf4f11ab"
		"eu-south-2" = "ami-04d1ddc81a88a7ad7"
		"me-central-1" = "ami-0661cdc2105cec31a"
		"il-central-1" = "ami-0546bb094e46d1eaa"
		"eu-central-2" = "ami-0d454a62f9ff835de"
		"af-south-1" = "ami-010233ed3c5827ae7"
		"ap-northeast-3" = "ami-05bce507dcfbe9389"
		"ca-west-1" = "ami-0ec8f763e01d66aab"
		"ap-southeast-3" = "ami-035184162f65f0ace"
		"ap-southeast-4" = "ami-09416cd08d49e2cf5"
  }
}
