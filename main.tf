...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-09dd798d3931c2c32"
		"eu-north-1" = "ami-0e66136c4614b5e8c"
		"ap-south-1" = "ami-0c550d0cc02a79ffa"
		"eu-west-3" = "ami-07f95ad63976ce1c4"
		"eu-west-2" = "ami-0fea182d35e96bb99"
		"eu-west-1" = "ami-0b6dfea11541d9215"
		"ap-northeast-2" = "ami-0a0e4101e3ec532f4"
		"me-south-1" = "ami-0c013ff184b10cbdc"
		"ap-northeast-1" = "ami-022755b87e35b3748"
		"sa-east-1" = "ami-0e1fa29bcbd0cf865"
		"ca-central-1" = "ami-03542b067a5a5043e"
		"ap-east-1" = "ami-0ad0a9ea610efef06"
		"ap-southeast-1" = "ami-03f4cfb340fafffa1"
		"ap-southeast-2" = "ami-05b8a700ccac6a5ad"
		"us-east-1" = "ami-0b743ca1f17ad0164"
		"us-east-2" = "ami-07445ebe272adf8e2"
		"us-west-1" = "ami-0dfe65f793843a394"
		"us-west-2" = "ami-099d5b08ba9f31cdb"
		"ap-south-2" = "ami-0b657fe45569fbc8e"
		"eu-south-1" = "ami-000a38b03244b1fc7"
		"eu-south-2" = "ami-03fdcbf49ff14e6df"
		"me-central-1" = "ami-0aa6b5524b3806aeb"
		"il-central-1" = "ami-0b32b69343f49617e"
		"eu-central-2" = "ami-0966d872f1870af89"
		"af-south-1" = "ami-07029212a03ad3f11"
		"ap-northeast-3" = "ami-0d7ecba55efa4d3d3"
		"ca-west-1" = "ami-0bf5c09f697521f2f"
		"ap-southeast-3" = "ami-04e5393925156412a"
		"ap-southeast-4" = "ami-050e383a0c722e79e"
  }
}
