...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-017b40a09e132d627"
		"eu-north-1" = "ami-06e18b77e82b8313f"
		"ap-south-1" = "ami-02dd69e98c7551e5d"
		"eu-west-3" = "ami-0b7dcbe214134b481"
		"eu-west-2" = "ami-0d700c86473fbf223"
		"eu-west-1" = "ami-079979144f3d4b531"
		"ap-northeast-2" = "ami-0788ef64cbad6fb05"
		"me-south-1" = "ami-05acd8fa0d1a96cfd"
		"ap-northeast-1" = "ami-0673aa57b46633258"
		"sa-east-1" = "ami-00bfb05aff44ee827"
		"ca-central-1" = "ami-0a475417edf3accd9"
		"ap-east-1" = "ami-0f59b439ce2b0f2de"
		"ap-southeast-1" = "ami-0533671f6c03342ca"
		"ap-southeast-2" = "ami-093658aacbcac1012"
		"us-east-1" = "ami-01392ca8b2ba06fc7"
		"us-east-2" = "ami-021d3ae82c652602f"
		"us-west-1" = "ami-01050baef49b15d7b"
		"us-west-2" = "ami-0c156e6b7d1865b73"
  }
}
