...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0116f3725b601e83c"
		"eu-north-1" = "ami-0f183300ca5c4e509"
		"ap-south-1" = "ami-0388a3451818a76e7"
		"eu-west-3" = "ami-0e73491c29679cb31"
		"eu-west-2" = "ami-0a8b68a118621ec20"
		"eu-west-1" = "ami-0084881fa248c3b62"
		"ap-northeast-2" = "ami-0177ef71cf5794b56"
		"me-south-1" = "ami-009811a7b021a3639"
		"ap-northeast-1" = "ami-0a2c67ff385f4f92e"
		"sa-east-1" = "ami-09d18de1167669a5c"
		"ca-central-1" = "ami-038c2895e486a3f95"
		"ap-east-1" = "ami-0470e4c8e8d615f48"
		"ap-southeast-1" = "ami-043e84e55919e4981"
		"ap-southeast-2" = "ami-0f70dd9dba04f010a"
		"us-east-1" = "ami-045cd76cc66b9c080"
		"us-east-2" = "ami-07192aba39bbcccbc"
		"us-west-1" = "ami-01787d7d83d43ee4c"
		"us-west-2" = "ami-0ff2e3f99bdbc41e8"
		"ap-south-2" = "ami-02e13fb4206af6778"
		"eu-south-1" = "ami-0e1b7ae3129b313bd"
		"eu-south-2" = "ami-02704ce66aa36445c"
		"me-central-1" = "ami-096f4af2a8c6bb36c"
		"il-central-1" = "ami-0bbc500b8138323b3"
		"eu-central-2" = "ami-0d91080887ce5665f"
		"af-south-1" = "ami-0f40b9ac9f6e0b303"
		"ap-northeast-3" = "ami-06dd43f8bd849aa17"
		"ca-west-1" = "ami-0a220aebdf72437e0"
		"ap-southeast-3" = "ami-0a1dcff83135bc300"
		"ap-southeast-4" = "ami-0ce6525a7b089198f"
  }
}
