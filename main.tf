...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-06838082f7a975d44"
		"eu-north-1" = "ami-068c302157fd026e7"
		"ap-south-1" = "ami-0a55e975b4d93adf4"
		"eu-west-3" = "ami-00698aa4cc139a34e"
		"eu-west-2" = "ami-0ab4d06eeb7a65806"
		"eu-west-1" = "ami-034950b5dd9cb4f3b"
		"ap-northeast-2" = "ami-019cc9632c889c3d4"
		"me-south-1" = "ami-08ecd63af8a2edab4"
		"ap-northeast-1" = "ami-085064a3c851183aa"
		"sa-east-1" = "ami-00e4ba9a65e4e0457"
		"ca-central-1" = "ami-0047b4a319d0ba791"
		"ap-east-1" = "ami-0ccc144e6a0a1609e"
		"ap-southeast-1" = "ami-0f502604fa4298555"
		"ap-southeast-2" = "ami-03dba91e3f27a977d"
		"us-east-1" = "ami-06c50bc46dd81aeec"
		"us-east-2" = "ami-024d078fc0a9028c0"
		"us-west-1" = "ami-099ffe2dfc8c25994"
		"us-west-2" = "ami-0e045ec451c86bb67"
  }
}
