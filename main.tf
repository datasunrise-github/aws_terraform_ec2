...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0634b90db141a2c5a"
		"eu-north-1" = "ami-00c7780930ab11dc1"
		"ap-south-1" = "ami-0888bc7948a72e2b7"
		"eu-west-3" = "ami-0c3453b6c5d5df42b"
		"eu-west-2" = "ami-0be59c38d1a787f68"
		"eu-west-1" = "ami-05244e64d2becebe2"
		"ap-northeast-2" = "ami-0cbc30ba761686aad"
		"me-south-1" = "ami-0fbc28f04da15f015"
		"ap-northeast-1" = "ami-0e1e7da6ea6264b7c"
		"sa-east-1" = "ami-0904dca5e5f578272"
		"ca-central-1" = "ami-0dbfd62c649f6f025"
		"ap-east-1" = "ami-0f2b275f6f2c8eebe"
		"ap-southeast-1" = "ami-06f55e6279bdf3c17"
		"ap-southeast-2" = "ami-0e72b50144370eb11"
		"us-east-1" = "ami-04fcd69c2356d2319"
		"us-east-2" = "ami-0a4832b185ae0b8c0"
		"us-west-1" = "ami-0c4a26af22e4f7f20"
		"us-west-2" = "ami-05dba421ef008411b"
  }
}
