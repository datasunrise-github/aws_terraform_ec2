...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-085789cbd8dc4ae9f"
		"eu-north-1" = "ami-00ff2a4b3bf500029"
		"ap-south-1" = "ami-085465ba177c93460"
		"eu-west-3" = "ami-0b06884c0ea34f77a"
		"eu-west-2" = "ami-08ab200347608e590"
		"eu-west-1" = "ami-026832eaf7f01f593"
		"ap-northeast-2" = "ami-024b413c1812bc861"
		"me-south-1" = "ami-0f58ea3e2d2d0abfd"
		"ap-northeast-1" = "ami-0dd530728ba9ba035"
		"sa-east-1" = "ami-0228db65816511d88"
		"ca-central-1" = "ami-0c9c6f731f0f3d19f"
		"ap-east-1" = "ami-0ffbfc7d58ad0f903"
		"ap-southeast-1" = "ami-0555cc7cb3e3b7f38"
		"ap-southeast-2" = "ami-00a6d234649d1ab1f"
		"us-east-1" = "ami-0686acf0007ca38d4"
		"us-east-2" = "ami-0c914accd3d919e0c"
		"us-west-1" = "ami-027e897edca48d01a"
		"us-west-2" = "ami-019c99052d30085fc"
  }
}
