...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0596bdfefe98db094"
		"eu-north-1" = "ami-0222f139181120bd1"
		"ap-south-1" = "ami-0ffadcc3f5d12f87f"
		"eu-west-3" = "ami-07951d6b8fa924957"
		"eu-west-2" = "ami-0d18d1f80180d1348"
		"eu-west-1" = "ami-0399d59389d520b92"
		"ap-northeast-2" = "ami-0f887f655e2fd1f97"
		"me-south-1" = "ami-0ebe4382568a9f637"
		"ap-northeast-1" = "ami-06049ab88c8b6865d"
		"sa-east-1" = "ami-0837dc1cc5390f6a9"
		"ca-central-1" = "ami-057e05cf250f50593"
		"ap-east-1" = "ami-0eb7d4e02f5244100"
		"ap-southeast-1" = "ami-0937451eae12d0f8e"
		"ap-southeast-2" = "ami-0a4b2389ed4b6cdd1"
		"us-east-1" = "ami-0d1c8688e3f3dcdd1"
		"us-east-2" = "ami-093df5eef0365f319"
		"us-west-1" = "ami-080d3d5c01341ac9d"
		"us-west-2" = "ami-0c9b52f4ea6a30401"
		"ap-south-2" = "ami-003ec4a3cfa5458ab"
		"eu-south-1" = "ami-0c6f76c90a765aa94"
		"eu-south-2" = "ami-0454f936e6a22b42c"
		"me-central-1" = "ami-0e463c7ac08bb8c5e"
		"il-central-1" = "ami-0002934b8756f11be"
		"eu-central-2" = "ami-0093d9f0baa94ddda"
		"af-south-1" = "ami-0b60391e86695ee93"
		"ap-northeast-3" = "ami-05797e52a20e6e110"
		"ca-west-1" = "ami-000644e2db345569b"
		"ap-southeast-3" = "ami-0e3c4eebadb69f700"
		"ap-southeast-4" = "ami-074651cbb98d6e632"
  }
}
