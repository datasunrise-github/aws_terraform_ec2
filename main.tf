...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0aa0106c152b7b8b1"
		"eu-north-1" = "ami-081232b8085c54369"
		"ap-south-1" = "ami-086108b0fb0b67870"
		"eu-west-3" = "ami-04155546545e9b0ca"
		"eu-west-2" = "ami-00e9b50ee035d78a3"
		"eu-west-1" = "ami-08f14a8bfdce34f47"
		"ap-northeast-2" = "ami-01455a8ea42d92aeb"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0bee6c6e85e32eeda"
		"sa-east-1" = "ami-01ae89ce2aec7540d"
		"ca-central-1" = "ami-03aeee8f97ed9bfee"
		"ap-east-1" = "ami-0b9cc2fc7eedd5e3a"
		"ap-southeast-1" = "ami-006dcbbf5c92c443d"
		"ap-southeast-2" = "ami-0f1baa000df83863d"
		"us-east-1" = "ami-0a34a77274cecc35d"
		"us-east-2" = "ami-0c14d1da35e4d6244"
		"us-west-1" = "ami-058b9a063203a939d"
		"us-west-2" = "ami-0d6fe9e26f391b1e9"
		"ap-south-2" = "ami-00476a209cfe1866e"
		"eu-south-1" = "ami-0624c0bc40aa908e4"
		"eu-south-2" = "ami-04ae85d2884d2d68e"
		"me-central-1" = "ami-03782bf87d0b70809"
		"il-central-1" = "ami-0186bc2669679b2a1"
		"eu-central-2" = "ami-03dfb3bc07d7139ab"
		"af-south-1" = "ami-0872b9b5c1717562c"
		"ap-northeast-3" = "ami-0b10ad7c68aef473f"
		"ca-west-1" = "ami-027c75b85f481e4f0"
		"ap-southeast-3" = "ami-077e9d080b7c5ee7f"
		"ap-southeast-4" = "ami-000cf5757fd3ff23c"
  }
}
