...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0ba5c8df1d3ff2f9d"
		"eu-north-1" = "ami-06732e380e89f7e1c"
		"ap-south-1" = "ami-04a53aa7714f3dbec"
		"eu-west-3" = "ami-033893b8e90328578"
		"eu-west-2" = "ami-04a6825c938357f9f"
		"eu-west-1" = "ami-09cbc369123ef3566"
		"ap-northeast-2" = "ami-050bf54a623ea0ce5"
		"me-south-1" = "ami-02d7a30bb3a0eb9fb"
		"ap-northeast-1" = "ami-001f013c8839574ee"
		"sa-east-1" = "ami-0005c1182a132f7e1"
		"ca-central-1" = "ami-0706194d92bd9f8b9"
		"ap-east-1" = "ami-0833d7729046e6831"
		"ap-southeast-1" = "ami-033f951b0a61ccc4c"
		"ap-southeast-2" = "ami-077aab479aeb8e35e"
		"us-east-1" = "ami-0840c49419c708462"
		"us-east-2" = "ami-0a13a42d8160d4b06"
		"us-west-1" = "ami-0385ae80ebe7ea136"
		"us-west-2" = "ami-07bb6a72e5caa73a5"
		"ap-south-2" = "ami-02cbb1967f8da47ee"
		"eu-south-1" = "ami-05b4d5cc6d5dd6b7d"
		"eu-south-2" = "ami-0660f0901a52e1e8f"
		"me-central-1" = "ami-02e2db6ca3f4ee03c"
		"il-central-1" = "ami-0abdfc51faa11d77f"
		"eu-central-2" = "ami-0d434065e539c7259"
		"af-south-1" = "ami-0406f6b73467d991d"
		"ap-northeast-3" = "ami-0110d0178d9e544dd"
		"ca-west-1" = "ami-02df51064fda5a49f"
		"ap-southeast-3" = "ami-02d9c81cd80796ed4"
		"ap-southeast-4" = "ami-0e0daa8162ff640bb"
  }
}
