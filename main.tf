...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-073d752233a34ad4d"
		"eu-north-1" = "ami-0243ecefd53118747"
		"ap-south-1" = "ami-0fa8d2a6dd6c629c1"
		"eu-west-3" = "ami-0e49c16cbddc32398"
		"eu-west-2" = "ami-0296dc2915b9c903a"
		"eu-west-1" = "ami-06c53ab36b8a6cd2e"
		"ap-northeast-2" = "ami-029bee1ef806134d1"
		"me-south-1" = "ami-0ae556ff4d007685d"
		"ap-northeast-1" = "ami-00a9c5c4dfa28dcb8"
		"sa-east-1" = "ami-02741bc84dadd8021"
		"ca-central-1" = "ami-0ebebc2ef51cb71eb"
		"ap-east-1" = "ami-0a0882f43f5ae941f"
		"ap-southeast-1" = "ami-053649427cbeb3f69"
		"ap-southeast-2" = "ami-089a81f6172484dc8"
		"us-east-1" = "ami-03d19373887d0afe3"
		"us-east-2" = "ami-05e505fda5b402a5f"
		"us-west-1" = "ami-044daa87faf760929"
		"us-west-2" = "ami-0f3f585d5451b6255"
		"ap-south-2" = "ami-0e9427240dfedcb39"
		"eu-south-1" = "ami-0b8ab0e404ee5e765"
		"eu-south-2" = "ami-0824eb03dfc61be99"
		"me-central-1" = "ami-0be76a89fd164923b"
		"il-central-1" = "ami-04d7f6ceeb4748aaf"
		"eu-central-2" = "ami-0e706135433eeb073"
		"af-south-1" = "ami-07167dab9a182534a"
		"ap-northeast-3" = "ami-09b9412b8f19df833"
		"ca-west-1" = "ami-02051f2d4747595f2"
		"ap-southeast-3" = "ami-055e2b6533aba7278"
		"ap-southeast-4" = "ami-0bd4266a3a5a02043"
  }
}
