...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0480c98a4488a6f80"
		"eu-north-1" = "ami-07028e027349e0cbc"
		"ap-south-1" = "ami-0b1c3277b518d4025"
		"eu-west-3" = "ami-0bad322d59eec982c"
		"eu-west-2" = "ami-0cfbe2ae4645703ab"
		"eu-west-1" = "ami-0038c806e4359b45c"
		"ap-northeast-2" = "ami-0e1c90beb048fb507"
		"me-south-1" = "ami-0059408b5a6544b04"
		"ap-northeast-1" = "ami-043277aa4a0ea9e6a"
		"sa-east-1" = "ami-0bda633d6af67cd4f"
		"ca-central-1" = "ami-07b491aa59279d1ea"
		"ap-east-1" = "ami-010322960c7dae24b"
		"ap-southeast-1" = "ami-07ffc9ff2b7cce475"
		"ap-southeast-2" = "ami-0f477bfe87945adba"
		"us-east-1" = "ami-05a4488a8ade467e1"
		"us-east-2" = "ami-0b51494277ce38784"
		"us-west-1" = "ami-0451f21292953d2b3"
		"us-west-2" = "ami-0d3a6e1a378a2dda9"
  }
}
