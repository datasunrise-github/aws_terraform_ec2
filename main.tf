...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0b3146b2781d06a7b"
		"eu-north-1" = "ami-0e32b31937651a095"
		"ap-south-1" = "ami-0b0dc4ff09ab06caa"
		"eu-west-3" = "ami-0350cc6da56d909d1"
		"eu-west-2" = "ami-09d70bc6f8c3d6de7"
		"eu-west-1" = "ami-0ac542242cfa69774"
		"ap-northeast-2" = "ami-0fdaac57b4b01b7c9"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-07b424aa82caeba20"
		"sa-east-1" = "ami-062a27d691009db28"
		"ca-central-1" = "ami-03e9f1cc35b232256"
		"ap-east-1" = "ami-04f1ebcb598fddff9"
		"ap-southeast-1" = "ami-0bd6ddff1e4e2c1e5"
		"ap-southeast-2" = "ami-07b52b5b970be451c"
		"us-east-1" = "ami-06d4bda46c52a9b74"
		"us-east-2" = "ami-0c1c160988e83c9d9"
		"us-west-1" = "ami-08f7dd17b891432db"
		"us-west-2" = "ami-0f76191506fe1c0db"
		"ap-south-2" = "ami-0a545b9f1227ddf9a"
		"eu-south-1" = "ami-0ec83da9f0d86d246"
		"eu-south-2" = "ami-0d227494c411ac611"
		"me-central-1" = "ami-02460fb353ce6947a"
		"il-central-1" = "ami-093c4c8b4c638d414"
		"eu-central-2" = "ami-004de36a4700ba083"
		"af-south-1" = "ami-0c1a923b45bdceb1e"
		"ap-northeast-3" = "ami-0025c3abc6ce0f70d"
		"ca-west-1" = "ami-08c02346b983cc9d3"
		"ap-southeast-3" = "ami-02fe72427885e8146"
		"ap-southeast-4" = "ami-043290f3c280c84e4"
  }
}
