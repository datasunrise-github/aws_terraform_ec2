...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0fc265f99271f730b"
		"eu-north-1" = "ami-08224db2ae69312ff"
		"ap-south-1" = "ami-0cc6a9b347c00dd16"
		"eu-west-3" = "ami-0399506867ab4890a"
		"eu-west-2" = "ami-030a9319b974751be"
		"eu-west-1" = "ami-0cc70e4b4d062b43f"
		"ap-northeast-2" = "ami-0ce56b568741e8f57"
		"me-south-1" = "ami-0a6338652fc4d5bc9"
		"ap-northeast-1" = "ami-0cbcb90afc71cc2f7"
		"sa-east-1" = "ami-02180a4a17ddf82f7"
		"ca-central-1" = "ami-0554cdd4d2a0e7e7f"
		"ap-east-1" = "ami-00861507515d13c8a"
		"ap-southeast-1" = "ami-032ab9f2168bc70f2"
		"ap-southeast-2" = "ami-06c8dafb314ba7aa1"
		"us-east-1" = "ami-0e1ad7bedaf2d3292"
		"us-east-2" = "ami-0a4e0f7fd89eb68a7"
		"us-west-1" = "ami-0c65fda55a45b2e71"
		"us-west-2" = "ami-0cc66ba6cf12f3984"
		"ap-south-2" = "ami-0b4fe9b173d8c4974"
		"eu-south-1" = "ami-014234e344a6c02a7"
		"eu-south-2" = "ami-0ecf77924e3ccab09"
		"me-central-1" = "ami-07cc410e7dc0912f0"
		"il-central-1" = "ami-0fe5061dbc884ec6a"
		"eu-central-2" = "ami-08a50e69a6811b889"
		"af-south-1" = "ami-029aa13ef9948dce5"
		"ap-northeast-3" = "ami-004cea6fdfbf23b69"
		"ca-west-1" = "ami-0e96c565ea31e7888"
		"ap-southeast-3" = "ami-0d4a76a4f9b92e265"
		"ap-southeast-4" = "ami-0c2ebb36cb83dd70f"
  }
}
