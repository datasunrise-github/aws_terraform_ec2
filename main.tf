...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-02844c846f3f346fa"
		"eu-north-1" = "ami-077a1209204b45c90"
		"ap-south-1" = "ami-05d2c44e43dd2c2e1"
		"eu-west-3" = "ami-0b82c1042390cec5c"
		"eu-west-2" = "ami-09fb970463ca8c4dd"
		"eu-west-1" = "ami-01d20a5e0ac319efc"
		"ap-northeast-2" = "ami-02b9ce10d742f6ec8"
		"me-south-1" = "ami-058f68c96c3cc6abd"
		"ap-northeast-1" = "ami-00f4e4797b18d8807"
		"sa-east-1" = "ami-0253f3b899f0367f1"
		"ca-central-1" = "ami-025df5e1583cb441b"
		"ap-east-1" = "ami-0c739420a42c3b254"
		"ap-southeast-1" = "ami-07f914134545fb9bd"
		"ap-southeast-2" = "ami-04a9e927a4013b656"
		"us-east-1" = "ami-048736f99b5c51f0b"
		"us-east-2" = "ami-0258f7c118a1fb7bb"
		"us-west-1" = "ami-027704f381c8b29f0"
		"us-west-2" = "ami-02db59a621f697949"
		"ap-south-2" = "ami-0b2735810e1ecc609"
		"eu-south-1" = "ami-095939a5673347b58"
		"eu-south-2" = "ami-00dfe0808a8b494fd"
		"me-central-1" = "ami-0e685cc3e6bd93de8"
		"il-central-1" = "ami-012d133b8c094d271"
		"eu-central-2" = "ami-0c4b90b6aba242f90"
		"af-south-1" = "ami-0b9bc1f133ec4a32f"
		"ap-northeast-3" = "ami-0349f549452e5baa2"
		"ca-west-1" = "ami-0ccab439c41aa0d96"
		"ap-southeast-3" = "ami-0bda48cc315d917dc"
		"ap-southeast-4" = "ami-0e751e762f024146a"
  }
}
