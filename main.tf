...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0bdddd4cc26fb3142"
		"eu-north-1" = "ami-002121dd3f9864f50"
		"ap-south-1" = "ami-08178f584eb7abc89"
		"eu-west-3" = "ami-081a8cc4d43eb0a3f"
		"eu-west-2" = "ami-0cffb6c9fb91341bd"
		"eu-west-1" = "ami-02149dd1e00b559ba"
		"ap-northeast-2" = "ami-0ccd0f12b3c531cf0"
		"me-south-1" = "ami-0f241005be9f34090"
		"ap-northeast-1" = "ami-0289ca2408a43abfd"
		"sa-east-1" = "ami-02d6658720cef6b81"
		"ca-central-1" = "ami-0eeab8dfe4c6d56d0"
		"ap-east-1" = "ami-08898b78c8170f1e8"
		"ap-southeast-1" = "ami-0040185db0982b9ef"
		"ap-southeast-2" = "ami-007add125470a471e"
		"us-east-1" = "ami-0fb8eec441b11a8e2"
		"us-east-2" = "ami-0312389efeb867289"
		"us-west-1" = "ami-04c84621d9d00bfd0"
		"us-west-2" = "ami-064d54d9aa3b8460f"
		"ap-south-2" = "ami-0859163691ee433c0"
		"eu-south-1" = "ami-092d66113f1c15ad4"
		"eu-south-2" = "ami-019aaad54cd86997d"
		"me-central-1" = "ami-0387c9c99caf71122"
		"il-central-1" = "ami-0e06ca095f6f74a07"
		"eu-central-2" = "ami-06bb5e32514083c0c"
		"af-south-1" = "ami-0f91bcc0ee9dca719"
		"ap-northeast-3" = "ami-05f3de5f615001f5e"
		"ca-west-1" = "ami-002a56560af38428a"
		"ap-southeast-3" = "ami-0e0db2bb36a8c2513"
		"ap-southeast-4" = "ami-0ab2a68794e155292"
  }
}
