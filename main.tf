...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-09e08c94abe8a8abf"
		"eu-north-1" = "ami-05a426b2044f6b003"
		"ap-south-1" = "ami-057f5951b94c0152e"
		"eu-west-3" = "ami-0a4beff7ac3ecee1d"
		"eu-west-2" = "ami-0f127c9b1124e2a4a"
		"eu-west-1" = "ami-0708cef5331b646b5"
		"ap-northeast-2" = "ami-01c9e9df8e2fba581"
		"me-south-1" = "ami-096f6ff43451201ba"
		"ap-northeast-1" = "ami-0dd906d61fbf2cfe0"
		"sa-east-1" = "ami-0195cae5d12676e15"
		"ca-central-1" = "ami-02bac48dfbb283f10"
		"ap-east-1" = "ami-07472e9b02afc6822"
		"ap-southeast-1" = "ami-09def90fc39bfcad1"
		"ap-southeast-2" = "ami-068f397fb7e448e6f"
		"us-east-1" = "ami-0d658bbd42d3c15cb"
		"us-east-2" = "ami-08367238c1fbbe20e"
		"us-west-1" = "ami-02df03ee3cf5cc86c"
		"us-west-2" = "ami-07621fecb0329ff4b"
		"ap-south-2" = "ami-07ccf263d1b79c960"
		"eu-south-1" = "ami-06307905107da06c9"
		"eu-south-2" = "ami-03abc708de1edbdb6"
		"me-central-1" = "ami-0ee0ae6217b78ad3a"
		"il-central-1" = "ami-08c9bffbee9954560"
		"eu-central-2" = "ami-01d3390205b9b4aca"
		"af-south-1" = "ami-0d1451223822df859"
		"ap-northeast-3" = "ami-000adcbaa36b95bfd"
		"ca-west-1" = "ami-0cbd819a31628931e"
		"ap-southeast-3" = "ami-0543db6fbc0042058"
		"ap-southeast-4" = "ami-000451a5280ff6df3"
  }
}
