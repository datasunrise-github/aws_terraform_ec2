...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0b4ae788e98ec9831"
		"eu-north-1" = "ami-0747193010019523a"
		"ap-south-1" = "ami-00d47f4b0b6959ebc"
		"eu-west-3" = "ami-081cb203a67a2b486"
		"eu-west-2" = "ami-08c99be95db4c37f7"
		"eu-west-1" = "ami-0501c81d28da1eebf"
		"ap-northeast-2" = "ami-09aa480ca1fe8144d"
		"me-south-1" = "ami-0a362797aadbdb849"
		"ap-northeast-1" = "ami-0ead9bf9ca346e133"
		"sa-east-1" = "ami-0dc6673bec20de0ea"
		"ca-central-1" = "ami-0398995e880103e1f"
		"ap-east-1" = "ami-04831ab44f82b4a96"
		"ap-southeast-1" = "ami-082382f11b5991f36"
		"ap-southeast-2" = "ami-04080814d45996c3f"
		"us-east-1" = "ami-0fc969ce2520ab241"
		"us-east-2" = "ami-020eab4fa01e60245"
		"us-west-1" = "ami-022312156567d33ee"
		"us-west-2" = "ami-08c6525d15c56e40e"
  }
}
