...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0b210f310986031e8"
		"eu-north-1" = "ami-0af57c0a5466c7d7e"
		"ap-south-1" = "ami-0b109a7a82a5a0911"
		"eu-west-3" = "ami-0095c1ead93476968"
		"eu-west-2" = "ami-095334e23052958f8"
		"eu-west-1" = "ami-01368a28ec893da45"
		"ap-northeast-2" = "ami-0dbc154646b24d5c3"
		"me-south-1" = "ami-08f81690a9a765f86"
		"ap-northeast-1" = "ami-0b4e87d581ecfbe47"
		"sa-east-1" = "ami-0ba3b0e99d2a2d047"
		"ca-central-1" = "ami-0da74b678c7f8ffd1"
		"ap-east-1" = "ami-09ee0f67a74968333"
		"ap-southeast-1" = "ami-0e8b2719d45c0db32"
		"ap-southeast-2" = "ami-0aee59304ce22561f"
		"us-east-1" = "ami-0e37c5f5c036f3c7b"
		"us-east-2" = "ami-0f38b59f95c9393df"
		"us-west-1" = "ami-09eb13636f8f16ad0"
		"us-west-2" = "ami-04c3bfe73f2d4c952"
  }
}
