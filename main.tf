...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-020dbe3fe052dfd99"
		"eu-north-1" = "ami-0ff82e451fc58f5d1"
		"ap-south-1" = "ami-00df65505c684b74a"
		"eu-west-3" = "ami-062eb31085ab155fe"
		"eu-west-2" = "ami-0b9cc25a16d6f09f3"
		"eu-west-1" = "ami-07f1da2ee81ea9629"
		"ap-northeast-2" = "ami-09ebffc21c1addb0e"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-088386c8b09fb1aea"
		"sa-east-1" = "ami-0dc085ee8cd5eb890"
		"ca-central-1" = "ami-013755211dcd07d5a"
		"ap-east-1" = "ami-0381f56b41a4c348f"
		"ap-southeast-1" = "ami-0471afe0394264a87"
		"ap-southeast-2" = "ami-052a59bbc10f2561f"
		"us-east-1" = "ami-02b9ade533410dd43"
		"us-east-2" = "ami-0bd94210866c33b7f"
		"us-west-1" = "ami-0626e26264692b9e4"
		"us-west-2" = "ami-0358bd3157f5dfd2c"
		"ap-south-2" = "ami-097fedbb255901630"
		"eu-south-1" = "ami-001fe5265a1917ecc"
		"eu-south-2" = "ami-0e1d616bc3fc9c216"
		"me-central-1" = "ami-02ab29d894aa8afc8"
		"il-central-1" = "ami-053fe7979004016dd"
		"eu-central-2" = "ami-06319dc6fbd168323"
		"af-south-1" = "ami-034815ffa476e9e90"
		"ap-northeast-3" = "ami-0fdc9e64f702d6711"
		"ca-west-1" = "ami-0404fe8fa2837264c"
		"ap-southeast-3" = "ami-0537ffbde56b9fccc"
		"ap-southeast-4" = "ami-0e6005e13704c2aaa"
  }
}
