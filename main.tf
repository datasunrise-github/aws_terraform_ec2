...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-04fd2b375269eba69"
		"eu-north-1" = "ami-0dc61cfe946e563aa"
		"ap-south-1" = "ami-014b97fc78eb9f180"
		"eu-west-3" = "ami-020b5624bb4771910"
		"eu-west-2" = "ami-0ef8e78799f4ce150"
		"eu-west-1" = "ami-0eb36a0681adb7d2a"
		"ap-northeast-2" = "ami-00e176db3c8caf0be"
		"me-south-1" = "ami-0b94acdf44cc19eba"
		"ap-northeast-1" = "ami-01b55f2ba6d1cda87"
		"sa-east-1" = "ami-0bf542c503b4c6208"
		"ca-central-1" = "ami-05f0aad898e8ddaf5"
		"ap-east-1" = "ami-0306e684535305269"
		"ap-southeast-1" = "ami-02d57d41cc7dc2524"
		"ap-southeast-2" = "ami-04a691879fb833ea6"
		"us-east-1" = "ami-07341fae7392d2960"
		"us-east-2" = "ami-06558d6392670f868"
		"us-west-1" = "ami-092d7d1259411ee62"
		"us-west-2" = "ami-04b2ff45cce111bf3"
  }
}
