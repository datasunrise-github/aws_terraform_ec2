...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01a5dfd25b3c3bf0d"
		"eu-north-1" = "ami-0317ff0ec3b0e9364"
		"ap-south-1" = "ami-0a6ea5dc049528b83"
		"eu-west-3" = "ami-0ae85481e65282278"
		"eu-west-2" = "ami-00a8b9a20f09318fd"
		"eu-west-1" = "ami-004be91891f8cd5c0"
		"ap-northeast-2" = "ami-0097c559a470802ec"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-06085a67350b84d0e"
		"sa-east-1" = "ami-04afc8a54cf699367"
		"ca-central-1" = "ami-007ee2ae97be38469"
		"ap-east-1" = "ami-00b8435c14e5b209c"
		"ap-southeast-1" = "ami-03a9d55ca779b4f42"
		"ap-southeast-2" = "ami-0ef912e3dfcf5340e"
		"us-east-1" = "ami-09600860becce0977"
		"us-east-2" = "ami-0e95fdd7edaf6fc86"
		"us-west-1" = "ami-08f8e37db673a20c1"
		"us-west-2" = "ami-0d36d2224d0e22b6c"
		"ap-south-2" = "ami-09a87e8b39f36d317"
		"eu-south-1" = "ami-07b78b85113e6d43d"
		"eu-south-2" = "ami-0211eeec5851618f4"
		"me-central-1" = "ami-049f7a7f29e7e8ec7"
		"il-central-1" = "ami-0f2b505e92db70fc6"
		"eu-central-2" = "ami-00d5e80e6ac06bcff"
		"af-south-1" = "ami-027fdceb781d95cad"
		"ap-northeast-3" = "ami-029f5c3b628c7266a"
		"ca-west-1" = "ami-0a573239a93241dfe"
		"ap-southeast-3" = "ami-04605102a902a95ec"
		"ap-southeast-4" = "ami-0cc7b7492783d7100"
  }
}
