...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0651231ce130e05b7"
		"eu-north-1" = "ami-08b5347062781092f"
		"ap-south-1" = "ami-06135bc41a1fd0161"
		"eu-west-3" = "ami-0112d7017aa0f8a99"
		"eu-west-2" = "ami-0bd653b98f47efd92"
		"eu-west-1" = "ami-0cbea8a56ea7b3d32"
		"ap-northeast-2" = "ami-04a5ff80d73ba8eef"
		"me-south-1" = "ami-0779f185c8ece48c4"
		"ap-northeast-1" = "ami-05f4aadb7cbfbab38"
		"sa-east-1" = "ami-0cdbbd3957287f3c1"
		"ca-central-1" = "ami-0d1834f75fbe5914f"
		"ap-east-1" = "ami-06bc4d92c6f7dbad9"
		"ap-southeast-1" = "ami-0f4e8e4b55ee11a8a"
		"ap-southeast-2" = "ami-082c83ccb4c0fdde5"
		"us-east-1" = "ami-0c5fbabc5c5e295f2"
		"us-east-2" = "ami-006bcf7f6d5f31c2f"
		"us-west-1" = "ami-03727cf04bb5d8eff"
		"us-west-2" = "ami-071245ebe2e663e90"
		"ap-south-2" = "ami-07da075525459fec8"
		"eu-south-1" = "ami-0ca513d7d466122d8"
		"eu-south-2" = "ami-0456aa232cc3a7ca8"
		"me-central-1" = "ami-040cf4716c8567ab2"
		"il-central-1" = "ami-0bac49dd29c97d895"
		"eu-central-2" = "ami-0f019bcb7d84ed79b"
		"af-south-1" = "ami-09bf63e22f20f9c99"
		"ap-northeast-3" = "ami-067dc5ac34516dfee"
		"ca-west-1" = "ami-0d7537083e45c9014"
		"ap-southeast-3" = "ami-0a7ab089a039f93ce"
		"ap-southeast-4" = "ami-06bf786a6dd47ed1e"
  }
}
