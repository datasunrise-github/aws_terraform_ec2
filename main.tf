...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-03dc076e4f7a63dc0"
		"eu-north-1" = "ami-0af14f3677fa1f4aa"
		"ap-south-1" = "ami-00cfd638d89af1ad4"
		"eu-west-3" = "ami-0a4806aed22a0e04b"
		"eu-west-2" = "ami-094819bfb2e888f1c"
		"eu-west-1" = "ami-0a8dca7fd9c8eae5a"
		"ap-northeast-2" = "ami-0be2be2b2af2e44a1"
		"me-south-1" = "ami-0ccba7435e55a82ca"
		"ap-northeast-1" = "ami-08c4501e530b29979"
		"sa-east-1" = "ami-056c42b471988fba7"
		"ca-central-1" = "ami-0c128765d5dcea2b4"
		"ap-east-1" = "ami-05e79b3117f1c76b8"
		"ap-southeast-1" = "ami-0209585ada17b4c9d"
		"ap-southeast-2" = "ami-0b851aab0f1eded80"
		"us-east-1" = "ami-04d569d81cf501f66"
		"us-east-2" = "ami-0ce68441218c58967"
		"us-west-1" = "ami-0f3d6cf852e305cf5"
		"us-west-2" = "ami-09d34d7c3375f9301"
		"ap-south-2" = "ami-0ecd199bd7aca913f"
		"eu-south-1" = "ami-063515363785e5194"
		"eu-south-2" = "ami-06b8a9db78bbe68ba"
		"me-central-1" = "ami-0be19c540e42c84ff"
		"il-central-1" = "ami-04dfa70e1c1170411"
		"eu-central-2" = "ami-02a821b4e72ec6ff2"
		"af-south-1" = "ami-064292a6d243ad5cb"
		"ap-northeast-3" = "ami-0445decc02dac5120"
		"ca-west-1" = "ami-0b2d09ae59826e1c5"
		"ap-southeast-3" = "ami-0631fb1c95071e52a"
		"ap-southeast-4" = "ami-02968378bab1fd535"
  }
}
