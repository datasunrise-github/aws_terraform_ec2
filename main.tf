...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-090e29ca110b2c67e"
		"eu-north-1" = "ami-0bfc0d97ce64ac0a1"
		"ap-south-1" = "ami-0015a0f14638c4220"
		"eu-west-3" = "ami-02de6097faaa02659"
		"eu-west-2" = "ami-0b9cd030ea731b358"
		"eu-west-1" = "ami-0a3fb8ca8ae1027f8"
		"ap-northeast-2" = "ami-08e1d56259bd6346b"
		"me-south-1" = "ami-0ac8d5c1c99b9afb8"
		"ap-northeast-1" = "ami-0d24affbdcdc4e4bf"
		"sa-east-1" = "ami-0aaf233fa0b6e6b83"
		"ca-central-1" = "ami-00e403ba9433d723d"
		"ap-east-1" = "ami-081f4ca67628f7313"
		"ap-southeast-1" = "ami-04cee17cf05ec864e"
		"ap-southeast-2" = "ami-0567464ac2af9ebb6"
		"us-east-1" = "ami-0e9059a6002200c3a"
		"us-east-2" = "ami-0482bff3d5ff84e44"
		"us-west-1" = "ami-05e092a38bdef6ab0"
		"us-west-2" = "ami-0e586f957c60fb2b7"
  }
}
