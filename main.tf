...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0e7fbd87cbc6ffd8e"
		"eu-north-1" = "ami-0870a07cd9076bd0d"
		"ap-south-1" = "ami-0ae4efed6492d59fd"
		"eu-west-3" = "ami-0b6fdb83a74a89535"
		"eu-west-2" = "ami-0bf00bacb94659c06"
		"eu-west-1" = "ami-07f249474c9e06d18"
		"ap-northeast-2" = "ami-095bcdd5d3e0d0dab"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-071f09c9faba9bf9a"
		"sa-east-1" = "ami-0952f0b9d63f3e230"
		"ca-central-1" = "ami-025737b3b1707f933"
		"ap-east-1" = "ami-007ef2a6130f7f768"
		"ap-southeast-1" = "ami-0040cd1b27622da4e"
		"ap-southeast-2" = "ami-04ae3ad50d1d654bc"
		"us-east-1" = "ami-0ca5bd42f50b4716a"
		"us-east-2" = "ami-071a5cd93e3cb4111"
		"us-west-1" = "ami-0e6522407dc1346e4"
		"us-west-2" = "ami-07b034c61419c8310"
		"ap-south-2" = "ami-0e06367caccc799d1"
		"eu-south-1" = "ami-05533077ac39c37cb"
		"eu-south-2" = "ami-038788e6729d41935"
		"me-central-1" = "ami-07a77e83a3bcd6b03"
		"il-central-1" = "ami-043b426a1044639dd"
		"eu-central-2" = "ami-0c4c93d8a502b04c9"
		"af-south-1" = "ami-0f39572f90ebd88c5"
		"ap-northeast-3" = "ami-09650b4f3323cf793"
		"ca-west-1" = "ami-05e1318166ac7a5dc"
		"ap-southeast-3" = "ami-0d7a9a4155c97b145"
		"ap-southeast-4" = "ami-0903264ba9490dc91"
  }
}
