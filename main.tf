...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0b13ec1e1f4fa1a44"
		"eu-north-1" = "ami-0d1f00950ca5867a1"
		"ap-south-1" = "ami-034b610ec7fbc0391"
		"eu-west-3" = "ami-0b3719130dfd42213"
		"eu-west-2" = "ami-070e7a7213fa80439"
		"eu-west-1" = "ami-0b1253546762c2656"
		"ap-northeast-2" = "ami-0c0a9db3e82a9444d"
		"me-south-1" = "ami-03202e1f493be7b8b"
		"ap-northeast-1" = "ami-0d4e13630ce7064da"
		"sa-east-1" = "ami-00b5c069f45b8bb81"
		"ca-central-1" = "ami-08721bb73b7c11f88"
		"ap-east-1" = "ami-042ace54aea704c37"
		"ap-southeast-1" = "ami-0401eb092c67e9a88"
		"ap-southeast-2" = "ami-078831240d0f51500"
		"us-east-1" = "ami-0639c9e1b7c0ef090"
		"us-east-2" = "ami-07d480e5d7c576827"
		"us-west-1" = "ami-016fcfb91657a50b8"
		"us-west-2" = "ami-06a6d18f1961213ac"
  }
}
