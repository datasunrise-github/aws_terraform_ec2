...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-084f5f97937bb1251"
		"eu-north-1" = "ami-0a14d25ff9f5351bf"
		"ap-south-1" = "ami-0a5c7cba1aca86aed"
		"eu-west-3" = "ami-08ab48d6340232708"
		"eu-west-2" = "ami-0792808e4d33bb2ef"
		"eu-west-1" = "ami-0580800fdaef473c6"
		"ap-northeast-2" = "ami-055c136c1c2123c95"
		"me-south-1" = "ami-0fdcc0b842301774f"
		"ap-northeast-1" = "ami-0ef024281c0f89be3"
		"sa-east-1" = "ami-0fd98c5290c9cd9e5"
		"ca-central-1" = "ami-033d3c9ddeebda071"
		"ap-east-1" = "ami-0469fb90818c057d9"
		"ap-southeast-1" = "ami-08bb9b4c3be7a7b94"
		"ap-southeast-2" = "ami-083fff47b06fdba5e"
		"us-east-1" = "ami-0fbfef753f3a7e970"
		"us-east-2" = "ami-0f283e64d1a33e2b5"
		"us-west-1" = "ami-00d6f1ec4b5a330ad"
		"us-west-2" = "ami-0356d26c947184f39"
		"ap-south-2" = "ami-0be7fd283ea3d0811"
		"eu-south-1" = "ami-0d42e7ea8d9cdb313"
		"eu-south-2" = "ami-09a30f87531a094f1"
		"me-central-1" = "ami-008402663777e9556"
		"il-central-1" = "ami-0434a5e3a566702b9"
		"eu-central-2" = "ami-09310cd7333de85af"
		"af-south-1" = "ami-0133a25c752650ae7"
		"ap-northeast-3" = "ami-0a185ed9488bd9758"
		"ca-west-1" = "ami-0b6ad7023244cfc78"
		"ap-southeast-3" = "ami-096951469adda8438"
		"ap-southeast-4" = "ami-06a4f2df41a2cfc87"
  }
}
