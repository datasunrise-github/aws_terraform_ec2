...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0210d42b4037a50ef"
		"eu-north-1" = "ami-0f87fd52426749272"
		"ap-south-1" = "ami-08d6cff086de53e9e"
		"eu-west-3" = "ami-0e018aaf3ad254e26"
		"eu-west-2" = "ami-09d4849000b845b31"
		"eu-west-1" = "ami-06db3dc8e992e0a42"
		"ap-northeast-2" = "ami-07e6ebeca1d4bb968"
		"me-south-1" = "ami-0842270eff4e96780"
		"ap-northeast-1" = "ami-00ee5875e32776e4d"
		"sa-east-1" = "ami-0e10eff97957270a1"
		"ca-central-1" = "ami-0d4e6935d5e20164c"
		"ap-east-1" = "ami-01c8f45b86dada6e6"
		"ap-southeast-1" = "ami-03b0a8c6f6a346e1b"
		"ap-southeast-2" = "ami-00649ece1de0e078b"
		"us-east-1" = "ami-095235e9c89de68b4"
		"us-east-2" = "ami-08efbe396aeace2fa"
		"us-west-1" = "ami-06bb23086c3cab129"
		"us-west-2" = "ami-07b9dc95e81ed1d19"
  }
}
