...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-00677257f5bed1719"
		"eu-north-1" = "ami-0cd95a7e251f1b991"
		"ap-south-1" = "ami-031cbffac8639cdab"
		"eu-west-3" = "ami-0bd0c764833b6a4ee"
		"eu-west-2" = "ami-0b6ecbe0ad9943e97"
		"eu-west-1" = "ami-0bd879365ad4530b8"
		"ap-northeast-2" = "ami-0987f1c8c3f22d782"
		"me-south-1" = "ami-0efdc95de80a6d639"
		"ap-northeast-1" = "ami-0b9ad66b0ad6c948f"
		"sa-east-1" = "ami-0b8ab6b78bbd2b170"
		"ca-central-1" = "ami-0b736f964a844f932"
		"ap-east-1" = "ami-0fd55e0ac66c9e85c"
		"ap-southeast-1" = "ami-08055d697ebab19bc"
		"ap-southeast-2" = "ami-04f641212058da91c"
		"us-east-1" = "ami-08d1685646f3c9598"
		"us-east-2" = "ami-0e4ae65e35bdde2de"
		"us-west-1" = "ami-0b573629e343a9019"
		"us-west-2" = "ami-0b58968a3659d5be2"
  }
}
