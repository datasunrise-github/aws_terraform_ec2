...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0327897fe0da2b68d"
		"eu-north-1" = "ami-0d88e6c55e73359dc"
		"ap-south-1" = "ami-047c92328170d763c"
		"eu-west-3" = "ami-0f1975d895cae79eb"
		"eu-west-2" = "ami-043dde70f01aa46be"
		"eu-west-1" = "ami-0c4b28355fb4cf9e8"
		"ap-northeast-2" = "ami-0297af3e3bad99564"
		"me-south-1" = "ami-0cbb5e2460769d4c8"
		"ap-northeast-1" = "ami-0b45fe2ae06c327b7"
		"sa-east-1" = "ami-0693b2b0455712cf5"
		"ca-central-1" = "ami-0282fba782a098bff"
		"ap-east-1" = "ami-0c8b1949a895012c5"
		"ap-southeast-1" = "ami-0f9fe5103b78ca425"
		"ap-southeast-2" = "ami-0514edddb35903268"
		"us-east-1" = "ami-057636a5ee9486b44"
		"us-east-2" = "ami-0785729c08e729d7a"
		"us-west-1" = "ami-0ecc6c12ec97bd537"
		"us-west-2" = "ami-0428805716955a59c"
  }
}
