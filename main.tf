...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0b3655600ce15b573"
		"eu-north-1" = "ami-0cf61a8c04cd767bc"
		"ap-south-1" = "ami-0f93f01765c645eef"
		"eu-west-3" = "ami-0efa8931c9ed80aba"
		"eu-west-2" = "ami-0e1252a1674bf0b2d"
		"eu-west-1" = "ami-0882d7638d1e4f20a"
		"ap-northeast-2" = "ami-00ddb52b1afbbe9a8"
		"me-south-1" = "ami-0595b726f5491c894"
		"ap-northeast-1" = "ami-0aa4e8a21ddb9ab31"
		"sa-east-1" = "ami-0798a2f5e07b51219"
		"ca-central-1" = "ami-08da34157e09e640b"
		"ap-east-1" = "ami-00fb342f6f33b6fb7"
		"ap-southeast-1" = "ami-0fa9ea7e38234d4a0"
		"ap-southeast-2" = "ami-06eff87e5bf29cd6b"
		"us-east-1" = "ami-0a8a05cedec78dca2"
		"us-east-2" = "ami-058d951c975640eb4"
		"us-west-1" = "ami-06b2fc8a1bf5d3346"
		"us-west-2" = "ami-090acde842d4b30e9"
  }
}
