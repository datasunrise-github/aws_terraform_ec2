...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-06979e076d651afcc"
		"eu-north-1" = "ami-0994c6b6fa9745dfd"
		"ap-south-1" = "ami-046780383da2efad2"
		"eu-west-3" = "ami-07d8ced8513fcd41a"
		"eu-west-2" = "ami-041f1cf34146160a3"
		"eu-west-1" = "ami-0f8024fd1d28f8390"
		"ap-northeast-2" = "ami-0545a92cec09d6bc6"
		"me-south-1" = "ami-01fa7e40aacf182aa"
		"ap-northeast-1" = "ami-0c3ee89224ef62f68"
		"sa-east-1" = "ami-05709fc0b53c5aaa6"
		"ca-central-1" = "ami-0b82686f572cd42e0"
		"ap-east-1" = "ami-06459fe0715a2244a"
		"ap-southeast-1" = "ami-06075c270ddfc2366"
		"ap-southeast-2" = "ami-05b6a58ca24a531d5"
		"us-east-1" = "ami-0ca4ee0a6d7a9b358"
		"us-east-2" = "ami-0ec5e7a5d0be69b24"
		"us-west-1" = "ami-04e358baa6e9b00d2"
		"us-west-2" = "ami-0a63175e386abad26"
		"ap-south-2" = "ami-0d4320287d6783419"
		"eu-south-1" = "ami-0bfc75b5c08fbe22e"
		"eu-south-2" = "ami-0f1faa6cd85e6fd64"
		"me-central-1" = "ami-007a2efa71360b1b9"
		"il-central-1" = "ami-0cb53d072dc1bf515"
		"eu-central-2" = "ami-02848ba588da23a7e"
		"af-south-1" = "ami-08f648a79b92404ed"
		"ap-northeast-3" = "ami-0ee46b9a7a4ba0454"
		"ca-west-1" = "ami-022beb628d32860e5"
		"ap-southeast-3" = "ami-0452ad12db31b8866"
		"ap-southeast-4" = "ami-0d525074213514806"
  }
}
