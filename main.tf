...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-03617d78fb17bb19c"
		"eu-north-1" = "ami-0b9ed16fcddde5dec"
		"ap-south-1" = "ami-026dc08552f7e0076"
		"eu-west-3" = "ami-0fec47ccfb5c159ee"
		"eu-west-2" = "ami-09f1d908e47b531c0"
		"eu-west-1" = "ami-03e3a0baabcaae360"
		"ap-northeast-2" = "ami-06c0b345ef35b9748"
		"me-south-1" = "ami-00d214c07bcd10bd9"
		"ap-northeast-1" = "ami-0fcee0f6036f86de1"
		"sa-east-1" = "ami-0ae0f899548235a0e"
		"ca-central-1" = "ami-007609055a78bc001"
		"ap-east-1" = "ami-01d13dbcc3d8437e6"
		"ap-southeast-1" = "ami-08f1a3a24ffdab2a8"
		"ap-southeast-2" = "ami-0a70ef63b0b4faeaa"
		"us-east-1" = "ami-0333a3efb15bd41bd"
		"us-east-2" = "ami-09aded1bd1716c9b4"
		"us-west-1" = "ami-031f88fc47f8b25c5"
		"us-west-2" = "ami-08709f7f606f552e0"
  }
}
