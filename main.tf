...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-03ebf3eef21a439f1"
		"eu-north-1" = "ami-088741ab892725006"
		"ap-south-1" = "ami-07cb8bfec00dd2d0f"
		"eu-west-3" = "ami-026fe266dd2601c1b"
		"eu-west-2" = "ami-0e4c27c077945d4d2"
		"eu-west-1" = "ami-0c516551ae1b8a16a"
		"ap-northeast-2" = "ami-079d53fb87c509ed0"
		"me-south-1" = "ami-063d61f1880b278ab"
		"ap-northeast-1" = "ami-04bc964a0faca9f5f"
		"sa-east-1" = "ami-0a78cb5de7907014d"
		"ca-central-1" = "ami-0495107509efcc316"
		"ap-east-1" = "ami-03dd91545e162ad3b"
		"ap-southeast-1" = "ami-05b559e2ff2f0245f"
		"ap-southeast-2" = "ami-0a077efe4a32eaadf"
		"us-east-1" = "ami-0d0e4448cec1b4216"
		"us-east-2" = "ami-06890d02e24bc8cba"
		"us-west-1" = "ami-0bf1454c8c08749e4"
		"us-west-2" = "ami-0fc8743aa270ab021"
		"ap-south-2" = "ami-080a24ad6bcb3c6f3"
		"eu-south-1" = "ami-0f0710e786330159a"
		"eu-south-2" = "ami-02d509128ce8b68c6"
		"me-central-1" = "ami-0cce2b912736b75f5"
		"il-central-1" = "ami-02cffaab6b0163e46"
		"eu-central-2" = "ami-0d525740fc7a3617c"
		"af-south-1" = "ami-0a480b369963aaf51"
		"ap-northeast-3" = "ami-09d97b2de2d277b61"
		"ca-west-1" = "ami-04a90c1da7440a5df"
		"ap-southeast-3" = "ami-0af8bc647bba78f4f"
		"ap-southeast-4" = "ami-09f5fb162da4c7102"
  }
}
