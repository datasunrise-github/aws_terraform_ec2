...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-02131d22fa8085619"
		"eu-north-1" = "ami-07d6aa1910ffaed05"
		"ap-south-1" = "ami-009307b0e933df92f"
		"eu-west-3" = "ami-0969ac236a63abe5a"
		"eu-west-2" = "ami-02f668695ead4039f"
		"eu-west-1" = "ami-09e2a717d58b159ec"
		"ap-northeast-2" = "ami-07cd6353ed513384e"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-005f6b63611c84562"
		"sa-east-1" = "ami-02f1649d98a2b7cda"
		"ca-central-1" = "ami-017cbdded6e431e1a"
		"ap-east-1" = "ami-03481dc4fb396d6d2"
		"ap-southeast-1" = "ami-088cda7d9d962d188"
		"ap-southeast-2" = "ami-0f1bbf8dfc3a0c922"
		"us-east-1" = "ami-08f1d7b1f6364500d"
		"us-east-2" = "ami-0c0a45534a86b81f4"
		"us-west-1" = "ami-0e587010e64a21068"
		"us-west-2" = "ami-08277f21aa85d9bb3"
		"ap-south-2" = "ami-053c296306700d142"
		"eu-south-1" = "ami-030f214e2b5ec765f"
		"eu-south-2" = "ami-05d893afb2dd5c135"
		"me-central-1" = "ami-0cc3c08df64c84f5a"
		"il-central-1" = "ami-039773b3c1966bda3"
		"eu-central-2" = "ami-0d8abf0176604a532"
		"af-south-1" = "ami-046bde31ec3069761"
		"ap-northeast-3" = "ami-06e930bfb5700bfbe"
		"ca-west-1" = "ami-07bc8a1edbd0caffc"
		"ap-southeast-3" = "ami-09778a495e8c990e6"
		"ap-southeast-4" = "ami-02b7e8b8f4801c641"
  }
}
