...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-088b549fe74a8a975"
		"eu-north-1" = "ami-0e766f3c396d72ef4"
		"ap-south-1" = "ami-0c2eeca3d78c61478"
		"eu-west-3" = "ami-00ed76fc859091507"
		"eu-west-2" = "ami-037a9093bf4edfb51"
		"eu-west-1" = "ami-0502cc6f49688f48c"
		"ap-northeast-2" = "ami-0701a14d08990e78a"
		"me-south-1" = "ami-02603e0686fe92d11"
		"ap-northeast-1" = "ami-0fec4e51d4da2baa9"
		"sa-east-1" = "ami-04781bc7462b64591"
		"ca-central-1" = "ami-04a06093406652519"
		"ap-east-1" = "ami-0cd86d62a4ff2dfe5"
		"ap-southeast-1" = "ami-0aaa90ae356373172"
		"ap-southeast-2" = "ami-00725e8c06e5eca1a"
		"us-east-1" = "ami-068f3c31ddbd5c548"
		"us-east-2" = "ami-08aafb001f282f536"
		"us-west-1" = "ami-08812db6d8f304728"
		"us-west-2" = "ami-0f1189d21ddb6fa40"
  }
}
