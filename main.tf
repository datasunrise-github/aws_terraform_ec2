...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-06344a5bd01f0789d"
		"eu-north-1" = "ami-08aae636dfed56629"
		"ap-south-1" = "ami-08c3ca9acf4178f53"
		"eu-west-3" = "ami-0c30d6e86d47f8bab"
		"eu-west-2" = "ami-01af0382556c6def2"
		"eu-west-1" = "ami-02eb121e4848ca7e3"
		"ap-northeast-2" = "ami-06f806c4d28be885d"
		"me-south-1" = "ami-09f42c549d0c0db2f"
		"ap-northeast-1" = "ami-0451475089e3b9ede"
		"sa-east-1" = "ami-006222138192709f4"
		"ca-central-1" = "ami-0e60f9981b2d431d8"
		"ap-east-1" = "ami-00c88f8e2f4c2bbcf"
		"ap-southeast-1" = "ami-0aeb163c17da3c7a7"
		"ap-southeast-2" = "ami-06b7ecb78e8cb535d"
		"us-east-1" = "ami-004fa40c1465eda52"
		"us-east-2" = "ami-014c01b8376a90ad8"
		"us-west-1" = "ami-06ab81eab559d3483"
		"us-west-2" = "ami-0748ae72e66046a29"
		"ap-south-2" = "ami-0775753b67d1ba4f1"
		"eu-south-1" = "ami-0f432b9d161fe598e"
		"eu-south-2" = "ami-090714884036bddf2"
		"me-central-1" = "ami-0062a88242733abc3"
		"il-central-1" = "ami-0aa679c5058d158a4"
		"eu-central-2" = "ami-063776ef2f78cceda"
		"af-south-1" = "ami-09b40389b93a90551"
		"ap-northeast-3" = "ami-0e7c342ff57ac848f"
		"ca-west-1" = "ami-0cbdca8d776ab4459"
		"ap-southeast-3" = "ami-0b33f5256787e5ca4"
		"ap-southeast-4" = "ami-010b738a35929d4c9"
  }
}
