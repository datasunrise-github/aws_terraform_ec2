...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0fd40ace54ae60a54"
		"eu-north-1" = "ami-0f8fed9b32fd204d3"
		"ap-south-1" = "ami-0a079af2aaa44628d"
		"eu-west-3" = "ami-006f973d1e255b62d"
		"eu-west-2" = "ami-0a9f0c6eb81f14573"
		"eu-west-1" = "ami-037165bce8dd4f090"
		"ap-northeast-2" = "ami-03ba9647c2f5503fc"
		"me-south-1" = "ami-0b5f6ba0380ed7ca1"
		"ap-northeast-1" = "ami-0efbe60d31b568fc6"
		"sa-east-1" = "ami-01b2263a41e525b57"
		"ca-central-1" = "ami-066a4be06e2f4e04e"
		"ap-east-1" = "ami-05634a496b4a495ab"
		"ap-southeast-1" = "ami-0f94f73caeb1126be"
		"ap-southeast-2" = "ami-0516cf437aedc0315"
		"us-east-1" = "ami-055cf5d67faf48de2"
		"us-east-2" = "ami-08c321225b801456d"
		"us-west-1" = "ami-0090ddc8aee623f19"
		"us-west-2" = "ami-01b0dd6627a539d1f"
		"ap-south-2" = "ami-0e519ca7051a7b565"
		"eu-south-1" = "ami-09a1e1996b8183b3d"
		"eu-south-2" = "ami-04af42123e2002f92"
		"me-central-1" = "ami-0bdf2eaddba0f36a5"
		"il-central-1" = "ami-05996d1eb5778ca5b"
		"eu-central-2" = "ami-01ecdf26ddd992979"
		"af-south-1" = "ami-0a10e7bba79fd7041"
		"ap-northeast-3" = "ami-0af708f07e16a5ce4"
		"ca-west-1" = "ami-09c3cca1aebf56e64"
		"ap-southeast-3" = "ami-01e7ca401ebe6043f"
		"ap-southeast-4" = "ami-02fb23b241f8a8bd3"
  }
}
