...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-019dfa110fa4bf2a0"
		"eu-north-1" = "ami-0438590fd501d80a0"
		"ap-south-1" = "ami-0133219c60f02b84d"
		"eu-west-3" = "ami-0217e7913ad857b40"
		"eu-west-2" = "ami-0e239b0695bf9f906"
		"eu-west-1" = "ami-0efeebce5a0329b89"
		"ap-northeast-2" = "ami-09a24d0dc67366f97"
		"me-south-1" = "ami-07718e2923d51e69e"
		"ap-northeast-1" = "ami-0c4547fc0b35a4b08"
		"sa-east-1" = "ami-0a2a274acf19472ad"
		"ca-central-1" = "ami-02b7c950886bd076c"
		"ap-east-1" = "ami-0e7160bfee47febe0"
		"ap-southeast-1" = "ami-0fbfacaf9ee79431b"
		"ap-southeast-2" = "ami-0282d35fc4b9040a4"
		"us-east-1" = "ami-083398bc75138a061"
		"us-east-2" = "ami-00fee3c0142bf63bd"
		"us-west-1" = "ami-0b5520755b60ef9d1"
		"us-west-2" = "ami-0a927358b04d7e1e1"
		"ap-south-2" = "ami-08687c40008621b33"
		"eu-south-1" = "ami-0cec8196b8d0c1829"
		"eu-south-2" = "ami-0da298dd117495b96"
		"me-central-1" = "ami-0cc78402efefa7d13"
		"il-central-1" = "ami-01adfc6a67056b275"
		"eu-central-2" = "ami-05569a60e478c873f"
		"af-south-1" = "ami-027e7c623dcf61cf4"
		"ap-northeast-3" = "ami-036ab9c52ab3b66e9"
		"ca-west-1" = "ami-05067a0bd6966db35"
		"ap-southeast-3" = "ami-054bdf68411bd537d"
		"ap-southeast-4" = "ami-08b3b53338b78b25f"
  }
}
