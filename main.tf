...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-02e7a5b32cf61643f"
		"eu-north-1" = "ami-010978c4dcc6592a4"
		"ap-south-1" = "ami-0c41420ab01459066"
		"eu-west-3" = "ami-0fa64a24a069a7697"
		"eu-west-2" = "ami-0b25a64d8aec1b49c"
		"eu-west-1" = "ami-0488b4596d63cebbe"
		"ap-northeast-2" = "ami-05af979907dc3c8f2"
		"me-south-1" = "ami-03bee3d3591e2c8f3"
		"ap-northeast-1" = "ami-0ce98f3df6111f64d"
		"sa-east-1" = "ami-0df70d0971039bbbe"
		"ca-central-1" = "ami-0b0673d0c9d57a7fe"
		"ap-east-1" = "ami-0d44e186e7d3efe26"
		"ap-southeast-1" = "ami-0c04f521584a883ca"
		"ap-southeast-2" = "ami-0a3a523f0f1401853"
		"us-east-1" = "ami-021bef340ed62379b"
		"us-east-2" = "ami-0029eec7ddc012f57"
		"us-west-1" = "ami-03f8d5a79621db2e3"
		"us-west-2" = "ami-00b2356433fbe4503"
  }
}
