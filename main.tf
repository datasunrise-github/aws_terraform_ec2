...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-099a945b3f79b2670"
		"eu-north-1" = "ami-0c5977b6254d4b299"
		"ap-south-1" = "ami-0769de32b647b648e"
		"eu-west-3" = "ami-00ecc9144366b2e02"
		"eu-west-2" = "ami-037a7e44b3386d094"
		"eu-west-1" = "ami-088b67e162b8f59f3"
		"ap-northeast-2" = "ami-0c1ceed58ce62e3aa"
		"me-south-1" = "ami-0a47616e761f60026"
		"ap-northeast-1" = "ami-08ed7350a9e168fdd"
		"sa-east-1" = "ami-0bd3701c6d43447d6"
		"ca-central-1" = "ami-0ecd4a24bd06467c2"
		"ap-east-1" = "ami-0393cfde7da55a81e"
		"ap-southeast-1" = "ami-07b734a470b159cbc"
		"ap-southeast-2" = "ami-017dc4ef90f885c8e"
		"us-east-1" = "ami-09ec96a59c502e585"
		"us-east-2" = "ami-07fbb801ba666d9f8"
		"us-west-1" = "ami-04e82296830575f3d"
		"us-west-2" = "ami-0f800110121529bd7"
  }
}
