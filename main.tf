...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0c11737082db40082"
		"eu-north-1" = "ami-00d54b7bb2bbb0c3a"
		"ap-south-1" = "ami-0e226569a3405e5c6"
		"eu-west-3" = "ami-01f0766863ccaba35"
		"eu-west-2" = "ami-0f18096c26a71058a"
		"eu-west-1" = "ami-00d01b9baf445b23a"
		"ap-northeast-2" = "ami-090f87470076af444"
		"me-south-1" = "ami-02a81226447cc858b"
		"ap-northeast-1" = "ami-0fd5d42e4644e3abb"
		"sa-east-1" = "ami-04dde3d54e5ce705c"
		"ca-central-1" = "ami-0c22ad23221b4bd59"
		"ap-east-1" = "ami-0a7107e3c91cc24b4"
		"ap-southeast-1" = "ami-04be90c2cab5e3474"
		"ap-southeast-2" = "ami-0c337109b5a0e0756"
		"us-east-1" = "ami-07f55c1964f967108"
		"us-east-2" = "ami-089383bfdba464930"
		"us-west-1" = "ami-0c1a0c21b988ec693"
		"us-west-2" = "ami-0fac413773d02044b"
  }
}
