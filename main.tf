...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0c1314d622a260431"
		"eu-north-1" = "ami-025083bd042add8bd"
		"ap-south-1" = "ami-08f19381a41291820"
		"eu-west-3" = "ami-05e113a523897cb0e"
		"eu-west-2" = "ami-06c3412384e3637fe"
		"eu-west-1" = "ami-03d97c154c31caf60"
		"ap-northeast-2" = "ami-0db92024397bf198d"
		"me-south-1" = "ami-083236ff26d3896cf"
		"ap-northeast-1" = "ami-0706b7129c4e4ef33"
		"sa-east-1" = "ami-018814a316e7bb9e2"
		"ca-central-1" = "ami-0c9e84ec434a81845"
		"ap-east-1" = "ami-0a91fe05c0147338f"
		"ap-southeast-1" = "ami-09fb47a9e56decc1f"
		"ap-southeast-2" = "ami-0da443f5f44ab38f2"
		"us-east-1" = "ami-0602cd3acadf00b15"
		"us-east-2" = "ami-00a263deebc4c4fba"
		"us-west-1" = "ami-0946dcdee8122f548"
		"us-west-2" = "ami-02ba2e2865fcab441"
		"ap-south-2" = "ami-05fafcd7fae18b329"
		"eu-south-1" = "ami-0e3c90fa149422375"
		"eu-south-2" = "ami-036d2d6649bcda4a5"
		"me-central-1" = ""
		"il-central-1" = "ami-087c9308e7dd50bbe"
		"eu-central-2" = "ami-0e41933c4c1b1da96"
		"af-south-1" = "ami-0f892615be9e91007"
		"ap-northeast-3" = "ami-001244ed9a2d3ea67"
		"ca-west-1" = "ami-0a0bb7037c6a05ea5"
		"ap-southeast-3" = "ami-063dc5719a7d6febf"
		"ap-southeast-4" = "ami-086b0fd8f404e9392"
  }
}
