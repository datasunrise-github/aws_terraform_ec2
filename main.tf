...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0773734ca6d25a957"
		"eu-north-1" = "ami-04a5505955333f854"
		"ap-south-1" = "ami-05ee57270ca884dbc"
		"eu-west-3" = "ami-0e24464e0605650ef"
		"eu-west-2" = "ami-0b802b29d09956a64"
		"eu-west-1" = "ami-0058d98c803ed2b30"
		"ap-northeast-2" = "ami-09c3f7d84543c89da"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0b2d8d3abed490a8f"
		"sa-east-1" = "ami-0d3412a5da4886d85"
		"ca-central-1" = "ami-0e5caf4aca0bf57e4"
		"ap-east-1" = "ami-0dfb67c95a1f39c44"
		"ap-southeast-1" = "ami-03da7d5068dba0b11"
		"ap-southeast-2" = "ami-02178dd7c50cbe407"
		"us-east-1" = "ami-09d228be2a0f0682c"
		"us-east-2" = "ami-045bbee401ab9b6b3"
		"us-west-1" = "ami-09d746f6064c27f8b"
		"us-west-2" = "ami-07d8f73e04b49a44b"
		"ap-south-2" = "ami-0ebefc067b3613da2"
		"eu-south-1" = "ami-00b9e3468a3ffced0"
		"eu-south-2" = "ami-07bddee93595566b9"
		"me-central-1" = "ami-01f5a73d1fbe0f1e4"
		"il-central-1" = "ami-07708ec65853bea26"
		"eu-central-2" = "ami-0c85a5943a429fedc"
		"af-south-1" = "ami-05e41e9ebff8005be"
		"ap-northeast-3" = "ami-0e51d04cc062b49ff"
		"ca-west-1" = "ami-0ddb22af49c399759"
		"ap-southeast-3" = "ami-0331727e4f16a7ca7"
		"ap-southeast-4" = "ami-0d76b5759b9f47da6"
  }
}
