...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0e245e2d032251b59"
		"eu-north-1" = "ami-0b87103083c42cdc6"
		"ap-south-1" = "ami-06d77ca1471d217a0"
		"eu-west-3" = "ami-0a7cb8d275cb6a3d6"
		"eu-west-2" = "ami-0a97b3bdfad534dd2"
		"eu-west-1" = "ami-0e905d538963d05c4"
		"ap-northeast-2" = "ami-05c3a059cc060b027"
		"me-south-1" = "ami-0b4e72a4049a3a8dc"
		"ap-northeast-1" = "ami-0d7f9571bd03efe8c"
		"sa-east-1" = "ami-0eb311d52edc211e4"
		"ca-central-1" = "ami-0178a0d0fb74d75d6"
		"ap-east-1" = "ami-05848a44f9c66f279"
		"ap-southeast-1" = "ami-0bb06a624b10f7a72"
		"ap-southeast-2" = "ami-0e28e226e187eaa33"
		"us-east-1" = "ami-0733de0874a565e59"
		"us-east-2" = "ami-0fbda1288609c1576"
		"us-west-1" = "ami-0cd7590756230e2f1"
		"us-west-2" = "ami-0977462271d2ebdd3"
		"ap-south-2" = "ami-098f12bd0a0d2039f"
		"eu-south-1" = "ami-07b6fae848a800764"
		"eu-south-2" = "ami-02a48d95c438679fa"
		"me-central-1" = "ami-03c79325e33ac2e0e"
		"il-central-1" = "ami-0bd68df281f0d287b"
		"eu-central-2" = "ami-0fef7481471ed3396"
		"af-south-1" = "ami-066199574f02eaf31"
		"ap-northeast-3" = "ami-0dd0c23df3578937c"
		"ca-west-1" = "ami-0437843e6fc32ad21"
		"ap-southeast-3" = "ami-0bcc1372a8d892d78"
		"ap-southeast-4" = "ami-07baf9a1a5bfebb11"
  }
}
