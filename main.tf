...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0e1e17638d5fae0c8"
		"eu-north-1" = "ami-0c9ff3cab17da652b"
		"ap-south-1" = "ami-02eefd51ad462c4bf"
		"eu-west-3" = "ami-029f4fbc1486f403a"
		"eu-west-2" = "ami-08d43691771db703b"
		"eu-west-1" = "ami-020ab3c63608243e4"
		"ap-northeast-2" = "ami-0cd4b1e0623b6f14a"
		"me-south-1" = "ami-0a2307d3997d7debf"
		"ap-northeast-1" = "ami-084946d9bf305576f"
		"sa-east-1" = "ami-08585e9d669fa5137"
		"ca-central-1" = "ami-07787e1fbc5c50f68"
		"ap-east-1" = "ami-0e180593b3547b451"
		"ap-southeast-1" = "ami-00e27afd2448bb65d"
		"ap-southeast-2" = "ami-03bf0e9298f1fd332"
		"us-east-1" = "ami-022e0044102a8c882"
		"us-east-2" = "ami-087d61c3161629a05"
		"us-west-1" = "ami-0a7d233c9c6fc0ef5"
		"us-west-2" = "ami-06b9c13c5cfe721cf"
  }
}
