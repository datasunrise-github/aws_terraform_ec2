...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0245fced4ebdd7ecb"
		"eu-north-1" = "ami-082b59270e84787e8"
		"ap-south-1" = "ami-0c35048dcf7d7089d"
		"eu-west-3" = "ami-0d42619c11673b486"
		"eu-west-2" = "ami-0d1d67cba33bf6b73"
		"eu-west-1" = "ami-04e15d564f360d162"
		"ap-northeast-2" = "ami-058dc128493b4ee38"
		"ap-northeast-1" = "ami-099fc8dbb7de22e59"
		"sa-east-1" = "ami-0f7730190daf87b70"
		"ca-central-1" = "ami-0e9df0827af149635"
		"ap-east-1" = "ami-037797db360d4d2e8"
		"ap-southeast-1" = "ami-01b0a0551a3ee22ae"
		"ap-southeast-2" = "ami-043fe4b3c629259fe"
		"us-east-1" = "ami-002e864715ee0ab04"
		"us-east-2" = "ami-08d2a564243affe8b"
		"us-west-1" = "ami-0b8b6a5637c71b806"
		"us-west-2" = "ami-045e69ec9532f6680"
		"ap-south-2" = "ami-042c589936e277f3a"
		"eu-south-1" = "ami-084f01f73bd3269f4"
		"eu-south-2" = "ami-0107e7c8e0de7e895"
		"me-central-1" = "ami-0a606867b8a991c9a"
		"il-central-1" = "ami-0abee4fc2a90a8a96"
		"eu-central-2" = "ami-02568fee4702629dd"
		"af-south-1" = "ami-0801fb0df326e80f1"
		"ap-northeast-3" = "ami-0eab45b7e46fc4f4e"
		"ca-west-1" = "ami-03fe5d38ae2968349"
		"ap-southeast-3" = "ami-07366dfa7b9ce2f4e"
		"ap-southeast-4" = "ami-00d764dda72c23255"
  }
}
