...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-085f7783d47e995bc"
		"eu-north-1" = "ami-0a23124674cc5cc35"
		"ap-south-1" = "ami-087edfa22dac0577a"
		"eu-west-3" = "ami-05f0a6194b92385e8"
		"eu-west-2" = "ami-080d8c6842af28df6"
		"eu-west-1" = "ami-064298e1369aca822"
		"ap-northeast-2" = "ami-04bd8e8ad9df19d78"
		"me-south-1" = "ami-0137d1a2c23912e2a"
		"ap-northeast-1" = "ami-0bec942496b2cacfb"
		"sa-east-1" = "ami-07d42a62787ad170e"
		"ca-central-1" = "ami-0c350fd80df2bddd5"
		"ap-east-1" = "ami-0745b745bf6f5615b"
		"ap-southeast-1" = "ami-05d72a04b0e518097"
		"ap-southeast-2" = "ami-0991e86a00b2f4726"
		"us-east-1" = "ami-090a9397c796733cd"
		"us-east-2" = "ami-0398c4390c7421dbc"
		"us-west-1" = "ami-04cdbbb7efbae21a2"
		"us-west-2" = "ami-06a052fe8dbc99dfb"
		"ap-south-2" = "ami-079585eb97a8de563"
		"eu-south-1" = "ami-08cf6e7d9033d5797"
		"eu-south-2" = "ami-04e2135890fffb9a8"
		"me-central-1" = "ami-09499bc228d31028e"
		"il-central-1" = "ami-03cab762f4d9a83bc"
		"eu-central-2" = "ami-0f5bda60588ff79ae"
		"af-south-1" = "ami-0f646bbdcd6b08ff2"
		"ap-northeast-3" = "ami-01d55f44994629975"
		"ca-west-1" = "ami-0902e465dba012a7b"
		"ap-southeast-3" = "ami-0d26d9123f2404dab"
		"ap-southeast-4" = "ami-0d915ec99c64bb4b1"
  }
}
