...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0f06623a49f64b01c"
		"eu-north-1" = "ami-0a41f7321493be533"
		"ap-south-1" = "ami-0f054dac28451eb96"
		"eu-west-3" = "ami-08edf6f73fdad765d"
		"eu-west-2" = "ami-0669a1636cfeab906"
		"eu-west-1" = "ami-0204262d2d3a6f245"
		"ap-northeast-2" = "ami-0125d577670513d8d"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-016b6d38fbe886ab1"
		"sa-east-1" = "ami-0684c609aa256ea8c"
		"ca-central-1" = "ami-08843fd171af59195"
		"ap-east-1" = "ami-0459733101664678e"
		"ap-southeast-1" = "ami-09375d0ae2b2ff331"
		"ap-southeast-2" = "ami-02d3ef8ddefe8382d"
		"us-east-1" = "ami-030c00fe7b778ee2f"
		"us-east-2" = "ami-0aa3a14f1a2ab60c7"
		"us-west-1" = "ami-03c7b417fdfbf19f9"
		"us-west-2" = "ami-062f9632ea13ec8fd"
		"ap-south-2" = "ami-05cddbc88ad5343cb"
		"eu-south-1" = "ami-0fd70749c8da37093"
		"eu-south-2" = "ami-05d061315e52af3ab"
		"me-central-1" = "ami-0f39f6f9f2defc71b"
		"il-central-1" = "ami-0318f3c691a431ddf"
		"eu-central-2" = "ami-09f33d35347876cba"
		"af-south-1" = "ami-0712df2262876afa1"
		"ap-northeast-3" = "ami-02111e996e57a3db9"
		"ca-west-1" = "ami-0d1a83ff227fd871f"
		"ap-southeast-3" = "ami-01fc3b089e131d5ed"
		"ap-southeast-4" = "ami-0b8004fcc435c4658"
  }
}
