...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0500f333222671b8d"
		"eu-north-1" = "ami-067b95c8f3eb1d6f0"
		"ap-south-1" = "ami-065782bcc8f230eb3"
		"eu-west-3" = "ami-0016bbf87e9b40686"
		"eu-west-2" = "ami-0f56fa46f5298382d"
		"eu-west-1" = "ami-04d65c3d07c450d0d"
		"ap-northeast-2" = "ami-0bdfec55e1b17c2ed"
		"me-south-1" = "ami-09879adb01e6b9a24"
		"ap-northeast-1" = "ami-05add2cc80d93ee21"
		"sa-east-1" = "ami-0a9f115f92df4231a"
		"ca-central-1" = "ami-072b27af8104bf260"
		"ap-east-1" = "ami-01c2ce9511d938183"
		"ap-southeast-1" = "ami-015a8230162619df9"
		"ap-southeast-2" = "ami-0845e0b4e69fa0d8e"
		"us-east-1" = "ami-0032f6d27ca7a28e6"
		"us-east-2" = "ami-0470e889ac6cf93ad"
		"us-west-1" = "ami-06beaeba90906b892"
		"us-west-2" = "ami-0d57b6685edb2a20e"
  }
}
