...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-09f6fc8b277079a3d"
		"eu-north-1" = "ami-09affe794a4c24ac5"
		"ap-south-1" = "ami-040e28f22efd03b83"
		"eu-west-3" = "ami-0c541603c384c6938"
		"eu-west-2" = "ami-0e9d040b1690249cb"
		"eu-west-1" = "ami-0abde0f31ec861ffe"
		"ap-northeast-2" = "ami-07ebead85f38c9d39"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0f05bfa049680074a"
		"sa-east-1" = "ami-0a57b6db02e7de334"
		"ca-central-1" = "ami-0d23d656c7ba998e5"
		"ap-east-1" = "ami-0397568df66bd35b9"
		"ap-southeast-1" = "ami-00fa192de4b3df821"
		"ap-southeast-2" = "ami-0ed3148837482a52d"
		"us-east-1" = "ami-09f1142e8828940a0"
		"us-east-2" = "ami-05dbda78a5d5258b5"
		"us-west-1" = "ami-05079fff8a9e36ab5"
		"us-west-2" = "ami-05a047dcb31fa421c"
		"ap-south-2" = "ami-05ef51475ed17c4cf"
		"eu-south-1" = "ami-074d5f71bea0b8345"
		"eu-south-2" = "ami-04fe86d172e2f7b7f"
		"me-central-1" = "ami-0c832ca50d649f30f"
		"il-central-1" = "ami-099376cc16ae23b4b"
		"eu-central-2" = "ami-0c4eaff7071241d21"
		"af-south-1" = "ami-00cf786a7919b61cd"
		"ap-northeast-3" = "ami-095863d1360dba614"
		"ca-west-1" = "ami-094babca2627eac2e"
		"ap-southeast-3" = "ami-03f7e2982bbe5beb9"
		"ap-southeast-4" = "ami-02690ed7e681f8665"
  }
}
