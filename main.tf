...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0e2a1e7d563db4427"
		"eu-north-1" = "ami-08407b695bc42c54e"
		"ap-south-1" = "ami-0edf081fcdf962426"
		"eu-west-3" = "ami-07e890302f8a302de"
		"eu-west-2" = "ami-0df64a748a90ab8a0"
		"eu-west-1" = "ami-0df0e95a821047d9f"
		"ap-northeast-2" = "ami-0a5bd5efa33b4a769"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-04197e34311094ce7"
		"sa-east-1" = "ami-0f0df3e3d50664d9f"
		"ca-central-1" = "ami-018ab41e02d8ca7cb"
		"ap-east-1" = "ami-0b2bc2c7096b9f036"
		"ap-southeast-1" = "ami-06931cc8d29dd52ae"
		"ap-southeast-2" = "ami-03b81c5314e7f1908"
		"us-east-1" = "ami-0d55cb30cf7f5c8ca"
		"us-east-2" = "ami-0f753d81588a5b14c"
		"us-west-1" = "ami-0b69ab7dd333c5afe"
		"us-west-2" = "ami-0baeebc8dd758f8af"
		"ap-south-2" = "ami-03e1645c96513b861"
		"eu-south-1" = "ami-0d7790e734585decd"
		"eu-south-2" = "ami-0f907e660539e3ed7"
		"me-central-1" = "ami-0eb027850efc225fa"
		"il-central-1" = "ami-0b5a0507a466d0fbd"
		"eu-central-2" = "ami-09c51f0025faaec76"
		"af-south-1" = "ami-068498fb78cd701e0"
		"ap-northeast-3" = "ami-06f3752aec9ef9ccf"
		"ca-west-1" = "ami-007153580e24563b3"
		"ap-southeast-3" = "ami-06760fe66983bb580"
		"ap-southeast-4" = "ami-096ba873b8e6101c5"
  }
}
