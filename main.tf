...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0afc46a91dee466c3"
		"eu-north-1" = "ami-028d9c1d0620a1279"
		"ap-south-1" = "ami-0ac9435f7fb981890"
		"eu-west-3" = "ami-04d0a1a485ccb6474"
		"eu-west-2" = "ami-070f957dc34eca480"
		"eu-west-1" = "ami-069050a9550f30696"
		"ap-northeast-2" = "ami-08ff34e0e702954a2"
		"me-south-1" = "ami-00b9bda5e753f36b3"
		"ap-northeast-1" = "ami-0d0affec33339f1f4"
		"sa-east-1" = "ami-005ae7a2e7862cc7e"
		"ca-central-1" = "ami-06171161be0af2984"
		"ap-east-1" = "ami-06a1caecd524fbb03"
		"ap-southeast-1" = "ami-0bb12620bc54b28c5"
		"ap-southeast-2" = "ami-07c497c7e4886e158"
		"us-east-1" = "ami-0be202ec365f29bfc"
		"us-east-2" = "ami-0561821eacee4207f"
		"us-west-1" = "ami-02c8d21896f0903cb"
		"us-west-2" = "ami-0360c57aab5050d3f"
		"ap-south-2" = "ami-09366f09df537c905"
		"eu-south-1" = "ami-0822ffbccf28c536d"
		"eu-south-2" = "ami-04cf7b582a0f39d34"
		"me-central-1" = "ami-03e59f727dad9178a"
		"il-central-1" = "ami-03af88867ca1915fa"
		"eu-central-2" = "ami-0a76669a4ff49b094"
		"af-south-1" = "ami-0c570548fa00b3b20"
		"ap-northeast-3" = "ami-00a9d10a8c028ff0f"
		"ca-west-1" = "ami-099b569e6a47aa8d7"
		"ap-southeast-3" = "ami-0f01200eb8723721f"
		"ap-southeast-4" = "ami-037e7bfa9d8cf117e"
  }
}
