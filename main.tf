...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0a8e6c892ef0e203b"
		"eu-north-1" = "ami-07f14d86e9c08cee1"
		"ap-south-1" = "ami-030f628a38c539551"
		"eu-west-3" = "ami-0098e1077f7c27dae"
		"eu-west-2" = "ami-02467fea22aad554c"
		"eu-west-1" = "ami-00ea0859cdd82d6c6"
		"ap-northeast-2" = "ami-0ba34aaa8aa99d0bc"
		"me-south-1" = "ami-0e8dd88f60cd36108"
		"ap-northeast-1" = "ami-059b2310cb81d4e11"
		"sa-east-1" = "ami-05274b9f4fe0e204f"
		"ca-central-1" = "ami-0ed50be7c16774a47"
		"ap-east-1" = "ami-057dd2bcb0bae054e"
		"ap-southeast-1" = "ami-0fd68114ddda00d69"
		"ap-southeast-2" = "ami-0be3755f9982f5e09"
		"us-east-1" = "ami-0a972281ff547cc8c"
		"us-east-2" = "ami-007abb4b22f1766e0"
		"us-west-1" = "ami-03cb67c789f12a8c7"
		"us-west-2" = "ami-0db879307d61ed543"
		"ap-south-2" = "ami-0abdb90839236537f"
		"eu-south-1" = "ami-0143c9ec7a0ef8aa3"
		"eu-south-2" = "ami-0f36fd3f740bd827c"
		"me-central-1" = "ami-0fd87204a8a6e5831"
		"il-central-1" = "ami-0220da531ddbf6388"
		"eu-central-2" = "ami-05f7779a937d975b3"
		"af-south-1" = "ami-00e8e012e3d4f5a3d"
		"ap-northeast-3" = "ami-01d4bc43ff868b5d2"
		"ca-west-1" = "ami-02a2109ae429027ee"
		"ap-southeast-3" = "ami-0ae7fd1b5de4833f4"
		"ap-southeast-4" = "ami-0506d67de673f6c6d"
  }
}
