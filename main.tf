...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0518e60054a279edf"
		"eu-north-1" = "ami-0695caf7aa30ed20c"
		"ap-south-1" = "ami-0ea85a26654c6ee9c"
		"eu-west-3" = "ami-0086dcdab9fed1924"
		"eu-west-2" = "ami-019d511be915442d7"
		"eu-west-1" = "ami-09b0872127d0cf0b9"
		"ap-northeast-2" = "ami-09b84bded35b50a7e"
		"me-south-1" = "ami-0baf6d78597741a0a"
		"ap-northeast-1" = "ami-063ea555b1c25f7d7"
		"sa-east-1" = "ami-0a3228777442e3c39"
		"ca-central-1" = "ami-08def14afd8966b2c"
		"ap-east-1" = "ami-0aabb97d52d848f43"
		"ap-southeast-1" = "ami-06b4e10f0c4ac7dc7"
		"ap-southeast-2" = "ami-0513c64e0deefdf6e"
		"us-east-1" = "ami-01abc496411238d98"
		"us-east-2" = "ami-040c141dfac268136"
		"us-west-1" = "ami-020a39341730babeb"
		"us-west-2" = "ami-0f525dfac3aced600"
		"ap-south-2" = "ami-0ddf8772f107039de"
		"eu-south-1" = "ami-081109229bbe107dd"
		"eu-south-2" = "ami-00ea17bcb48ec8e39"
		"me-central-1" = "ami-001999d3e5c9f2550"
		"il-central-1" = "ami-0261a5ea8c92fc15c"
		"eu-central-2" = "ami-0172b775b605c38c4"
		"af-south-1" = "ami-023b56222bf796c86"
		"ap-northeast-3" = "ami-0369d2908c73b5aba"
		"ca-west-1" = "ami-0de868f9f8829eb05"
		"ap-southeast-3" = "ami-0100b8d7ca6684783"
		"ap-southeast-4" = "ami-01e187258ae7f80a2"
  }
}
