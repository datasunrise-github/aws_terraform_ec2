...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-02b21365917bc2d4d"
		"eu-north-1" = "ami-0d83164b52867decc"
		"ap-south-1" = "ami-0f5fb6acced84bc1a"
		"eu-west-3" = "ami-0dabd2407178ff36e"
		"eu-west-2" = "ami-009a4d192e82ea3a3"
		"eu-west-1" = "ami-0890a06b24d120e38"
		"ap-northeast-2" = "ami-07083ca91aa12d62b"
		"me-south-1" = "ami-0f3a3e2cad61410c5"
		"ap-northeast-1" = "ami-04bd168ab08b0cfd4"
		"sa-east-1" = "ami-0a5e1d5e6d5e0ef54"
		"ca-central-1" = "ami-0394e92d95385a63e"
		"ap-east-1" = "ami-018cc20fa076d99be"
		"ap-southeast-1" = "ami-0d68732cce64806b5"
		"ap-southeast-2" = "ami-027b7f7a59db9113e"
		"us-east-1" = "ami-09ba56a6d1222c082"
		"us-east-2" = "ami-01a7d425e6393ef61"
		"us-west-1" = "ami-0b3e2aed1ddbbddb1"
		"us-west-2" = "ami-067ea44455dbf70b0"
		"ap-south-2" = "ami-069ec62ee9cdd447d"
		"eu-south-1" = "ami-05fc489cbe4891820"
		"eu-south-2" = "ami-0c21eef44d82f9c48"
		"me-central-1" = "ami-02446a81bcdbb04e1"
		"il-central-1" = "ami-05988f5a6b0210284"
		"eu-central-2" = "ami-0986be9dc49df5a60"
		"af-south-1" = "ami-00ceb2ef67d1b529e"
		"ap-northeast-3" = "ami-004fe701910f55643"
		"ca-west-1" = "ami-091ccbec89371bc0a"
		"ap-southeast-3" = "ami-0bc371aa3aad2e008"
		"ap-southeast-4" = "ami-084aa5bf4da84fc20"
  }
}
