...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01d8b17be6c1fac3a"
		"eu-north-1" = "ami-0319bc4eb77a97f54"
		"ap-south-1" = "ami-00a60ba23b7e40421"
		"eu-west-3" = "ami-0ce8577891b80798f"
		"eu-west-2" = "ami-03b3ea9b519dc68c0"
		"eu-west-1" = "ami-0269c78f06b2d7ad6"
		"ap-northeast-2" = "ami-046b0f4374e009daf"
		"me-south-1" = "ami-0620e99f307108939"
		"ap-northeast-1" = "ami-0e40efbd65d023c1e"
		"sa-east-1" = "ami-08d3f70eebbaa3639"
		"ca-central-1" = "ami-0e152949924fddbce"
		"ap-east-1" = "ami-03a13311e6ee40afb"
		"ap-southeast-1" = "ami-0f1288845f2168a52"
		"ap-southeast-2" = "ami-04216431d3ccef225"
		"us-east-1" = "ami-031b3fdd32c589a0f"
		"us-east-2" = "ami-0c0a476479a6d18f2"
		"us-west-1" = "ami-049bb82f6fc2ac428"
		"us-west-2" = "ami-0db744119fb537251"
		"ap-south-2" = "ami-01d6f4bfc055a4a66"
		"eu-south-1" = "ami-0250f2a1e732cf5bc"
		"eu-south-2" = "ami-036a2f9d0f25325d3"
		"me-central-1" = "ami-0cdd93b2c1568200a"
		"il-central-1" = "ami-0fa4cd36dc79cc12a"
		"eu-central-2" = "ami-085cbfddb48b16a26"
		"af-south-1" = "ami-029a775935c17b9d1"
		"ap-northeast-3" = "ami-0c6d0c38599d29301"
		"ca-west-1" = "ami-0cd68c3bfe9fbc206"
		"ap-southeast-3" = "ami-04f783c82395b2422"
		"ap-southeast-4" = "ami-03bc708a7706b1aa1"
  }
}
