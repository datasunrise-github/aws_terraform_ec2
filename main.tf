...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-01e1cc4b5d1871c0c"
		"eu-north-1" = "ami-01107759bf61fb0cb"
		"ap-south-1" = "ami-0f2e776e6d17c4b98"
		"eu-west-3" = "ami-076f2ffde37ff173c"
		"eu-west-2" = "ami-0128d80a1400cb825"
		"eu-west-1" = "ami-00c15a90106872318"
		"ap-northeast-2" = "ami-0c25b6a9a1f7d7374"
		"me-south-1" = "ami-055fba020d0723969"
		"ap-northeast-1" = "ami-0e8de4d6f08d8605a"
		"sa-east-1" = "ami-0035ecf679767d579"
		"ca-central-1" = "ami-00f7ad7b80be7aea5"
		"ap-east-1" = "ami-0a377722ec48ac2ee"
		"ap-southeast-1" = "ami-03baa9737b9d79cd0"
		"ap-southeast-2" = "ami-0f0e6fda631090bd6"
		"us-east-1" = "ami-0b8e5319f094b59bf"
		"us-east-2" = "ami-02df6a54be5abc3fc"
		"us-west-1" = "ami-0647c843d27160ebc"
		"us-west-2" = "ami-0d409a07989979fbf"
		"ap-south-2" = "ami-0844178a200d91902"
		"eu-south-1" = "ami-0d332d5250ea07c12"
		"eu-south-2" = "ami-0cd6ca673d5e9d5a2"
		"me-central-1" = "ami-0a63c7c2bf6c65a88"
		"il-central-1" = "ami-0fb9f29ad188f23a7"
		"eu-central-2" = "ami-034f66434dff5ce7f"
		"af-south-1" = "ami-016a16fff53fd60f4"
		"ap-northeast-3" = "ami-0a42b1393dca24bcb"
		"ca-west-1" = "ami-06e67e8b31e5ecde7"
		"ap-southeast-3" = "ami-000e70234838c2ab4"
		"ap-southeast-4" = "ami-028594b52b3b73771"
  }
}
