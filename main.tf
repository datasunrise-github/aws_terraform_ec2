...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-06fed7b7ae3bb4247"
		"eu-north-1" = "ami-0887eb31e7705f310"
		"ap-south-1" = "ami-0d73930329d73a16a"
		"eu-west-3" = "ami-0445ea47cc0369ff6"
		"eu-west-2" = "ami-0089259d6d196de79"
		"eu-west-1" = "ami-003e09c5c59e8bc57"
		"ap-northeast-2" = "ami-04bdb4272162a0047"
		"me-south-1" = "ami-0fe93b445327a6cd3"
		"ap-northeast-1" = "ami-066d7c42d4190a366"
		"sa-east-1" = "ami-09333051f7df50b44"
		"ca-central-1" = "ami-007f879a424373844"
		"ap-east-1" = "ami-04d40cc92705e5122"
		"ap-southeast-1" = "ami-0c9c0e3d26feb3ef5"
		"ap-southeast-2" = "ami-0bea07d4476d43cd4"
		"us-east-1" = "ami-01f89693e6de55410"
		"us-east-2" = "ami-035f7ead68eac8618"
		"us-west-1" = "ami-0c617964ed6ea27c7"
		"us-west-2" = "ami-089913196c1e32209"
  }
}
