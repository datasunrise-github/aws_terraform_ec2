...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0d612a6ee43d5de38"
		"eu-north-1" = "ami-049b35a0b94142d9c"
		"ap-south-1" = "ami-07ec0330959d80839"
		"eu-west-3" = "ami-0e202bebed4eee73a"
		"eu-west-2" = "ami-0d468e962639466e0"
		"eu-west-1" = "ami-0ed0e8198c5c7ff9a"
		"ap-northeast-2" = "ami-0beb945d0cb2e8855"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-073f7116f8a1ffbd0"
		"sa-east-1" = "ami-07794344cf57f16a3"
		"ca-central-1" = "ami-0fe25a1745015aef9"
		"ap-east-1" = "ami-04b870593020d845a"
		"ap-southeast-1" = "ami-0c67c6b7ef516a17f"
		"ap-southeast-2" = "ami-0895db5b9b4a3c1e4"
		"us-east-1" = "ami-0e788856383d30bfa"
		"us-east-2" = "ami-0333d1fcdb3335c7d"
		"us-west-1" = "ami-00878893d09c06861"
		"us-west-2" = "ami-0261f430fa1b14de2"
		"ap-south-2" = "ami-09d127185f8502101"
		"eu-south-1" = "ami-0b7ee04469530002a"
		"eu-south-2" = "ami-0884c2453046971c8"
		"me-central-1" = "ami-08ef52aece2fc5231"
		"il-central-1" = "ami-040db01beb24837b9"
		"eu-central-2" = "ami-0295f6808aa25ec2c"
		"af-south-1" = "ami-03e02eaeb8ff08181"
		"ap-northeast-3" = "ami-01fc249382ca837f3"
		"ca-west-1" = "ami-0d910bb106cdb0642"
		"ap-southeast-3" = "ami-0e2af261255458f30"
		"ap-southeast-4" = "ami-0c097f0be72f05ddb"
  }
}
