...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0073d18d37a65e648"
		"eu-north-1" = "ami-0730b272a11d745c8"
		"ap-south-1" = "ami-00f61974f9b15f760"
		"eu-west-3" = "ami-067fdc0d098e28c82"
		"eu-west-2" = "ami-081a4e019eb22fd15"
		"eu-west-1" = "ami-06a95455a59c2504d"
		"ap-northeast-2" = "ami-0bb150f775c24ded0"
		"me-south-1" = "ami-0a85999145cd60eee"
		"ap-northeast-1" = "ami-0843cbca43b8c5e84"
		"sa-east-1" = "ami-0c8a3e8fcbaec58bd"
		"ca-central-1" = "ami-05d3b738d0f3d5077"
		"ap-east-1" = "ami-0639260d6d012cb88"
		"ap-southeast-1" = "ami-0d1427d197a44b505"
		"ap-southeast-2" = "ami-01dacee6b688518d3"
		"us-east-1" = "ami-012c920dd507ab6d1"
		"us-east-2" = "ami-039a3a90dea3e7023"
		"us-west-1" = "ami-0c5806dc058716556"
		"us-west-2" = "ami-0147c18e8130cf103"
  }
}
