...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0c2e873e92bcf77f3"
		"eu-north-1" = "ami-09522ef3b9b5f3381"
		"ap-south-1" = "ami-037b8a119d873a71f"
		"eu-west-3" = "ami-0447a7fbe21049b6f"
		"eu-west-2" = "ami-0c0be5228fdab80c2"
		"eu-west-1" = "ami-041ae0b939392ed26"
		"ap-northeast-2" = "ami-085fca92115a64075"
		"me-south-1" = "ami-0e3230a9c8b85966e"
		"ap-northeast-1" = "ami-0b744f813c031896b"
		"sa-east-1" = "ami-0a544f0ba310fb073"
		"ca-central-1" = "ami-058db96fecf2deb12"
		"ap-east-1" = "ami-0cfb877da7031e119"
		"ap-southeast-1" = "ami-03a5221f0aae6c977"
		"ap-southeast-2" = "ami-08836d8384d170c69"
		"us-east-1" = "ami-0540db02b004d4860"
		"us-east-2" = "ami-06fdb70c36ce7e6b6"
		"us-west-1" = "ami-04c0f8d595ad88dc5"
		"us-west-2" = "ami-0cae82f574b5fccd9"
		"ap-south-2" = "ami-0f8fd20d186cc16aa"
		"eu-south-1" = "ami-0a732b670f63218c8"
		"eu-south-2" = "ami-0f3d3f5dd5c3fc815"
		"me-central-1" = "ami-0773f6e05992126c4"
		"il-central-1" = "ami-01b382ef990d66fed"
		"eu-central-2" = "ami-0aefe66beedd99431"
		"af-south-1" = "ami-08200e7631207ed56"
		"ap-northeast-3" = "ami-0295429a3351ef8e5"
		"ca-west-1" = "ami-06f1e1eb3def3a02d"
		"ap-southeast-3" = "ami-0c11475634ba44aad"
		"ap-southeast-4" = "ami-0c111d2b1389a2dca"
  }
}
