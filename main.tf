...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0f719a4b1a4f73155"
		"eu-north-1" = "ami-07c56ddd508bc2dd4"
		"ap-south-1" = "ami-015081caecfc3285e"
		"eu-west-3" = "ami-0c3501d5cb1d215c5"
		"eu-west-2" = "ami-0dc3542abb7171613"
		"eu-west-1" = "ami-00304aa815a110a63"
		"ap-northeast-2" = "ami-0a66f7ec45d733a10"
		"me-south-1" = "ami-09e8a83459ace13c1"
		"ap-northeast-1" = "ami-0dcb9a68f2b7472f9"
		"sa-east-1" = "ami-025e70bb59c0c84bf"
		"ca-central-1" = "ami-02046bbed588f604b"
		"ap-east-1" = "ami-001f775637baa3e05"
		"ap-southeast-1" = "ami-042f607bd2b7b2908"
		"ap-southeast-2" = "ami-04decb78a0d762b08"
		"us-east-1" = "ami-03a44ec9a5dff0018"
		"us-east-2" = "ami-077a126aedd632f4a"
		"us-west-1" = "ami-057c8316d8e2f3454"
		"us-west-2" = "ami-0669a4398b533abc0"
  }
}
