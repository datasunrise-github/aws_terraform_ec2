...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-046163c8cc510be72"
		"eu-north-1" = "ami-098f10c51a28c5aaf"
		"ap-south-1" = "ami-02e9ff1c7e3e003d8"
		"eu-west-3" = "ami-0cd51f0bf6e6a9e11"
		"eu-west-2" = "ami-0090200cd37cd14cb"
		"eu-west-1" = "ami-03a8dd4786f5f9283"
		"ap-northeast-2" = "ami-0eca8dc5d2fed311e"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0735d9632afb71339"
		"sa-east-1" = "ami-0846b9837b1b8f222"
		"ca-central-1" = "ami-028885a8a1f75f254"
		"ap-east-1" = "ami-0d80b68fffe12687a"
		"ap-southeast-1" = "ami-0020d50f2bf100db8"
		"ap-southeast-2" = "ami-0530e2dbef9411f57"
		"us-east-1" = "ami-0e852b11527b5b590"
		"us-east-2" = "ami-008e8039be5e23afd"
		"us-west-1" = "ami-04f40c05453bcb688"
		"us-west-2" = "ami-0d4ed19d5d359760a"
		"ap-south-2" = "ami-06ae8e4b64ac4eb45"
		"eu-south-1" = "ami-01deecb7605e3aec7"
		"eu-south-2" = "ami-0dd9d20966e6cd4e0"
		"me-central-1" = ""
		"il-central-1" = "ami-0371e94fd33bf56ad"
		"eu-central-2" = "ami-03dd5d4309129e468"
		"af-south-1" = "ami-0076c669345502c82"
		"ap-northeast-3" = "ami-0478b9182800e9ef7"
		"ca-west-1" = "ami-0c7fef01eb796a43e"
		"ap-southeast-3" = "ami-0be80d1b81de78714"
		"ap-southeast-4" = "ami-01fea8324ff33adaf"
  }
}
