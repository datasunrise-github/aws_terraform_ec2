...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-07f2f0e7f4adaf051"
		"eu-north-1" = "ami-0b4bdb4d886c69ce4"
		"ap-south-1" = "ami-04b38df9ffbfbf51b"
		"eu-west-3" = "ami-003ce6f11ec8ab9dc"
		"eu-west-2" = "ami-00a4e6f99db0ffc6b"
		"eu-west-1" = "ami-06775d74988f4974e"
		"ap-northeast-2" = "ami-0f21c0cdbfaf79fbb"
		"me-south-1" = "ami-05f948392d5858507"
		"ap-northeast-1" = "ami-035ccead0b3bc0ecd"
		"sa-east-1" = "ami-003a4446a43ec65b8"
		"ca-central-1" = "ami-07bfaaf384140d008"
		"ap-east-1" = "ami-02734a18c21a570de"
		"ap-southeast-1" = "ami-02f8bb475b23e9dfd"
		"ap-southeast-2" = "ami-03d2aa25a5dd5b120"
		"us-east-1" = "ami-0fbe86d9bdaff9a58"
		"us-east-2" = "ami-0f525089b1a9cc45a"
		"us-west-1" = "ami-0a8d2c8702e2f13b7"
		"us-west-2" = "ami-0bc22fb0f328a5504"
		"ap-south-2" = "ami-0b28279209e56de45"
		"eu-south-1" = "ami-0ab78bc980436054f"
		"eu-south-2" = "ami-00cf6ab729cccde51"
		"me-central-1" = "ami-0a7e85d78ea9d0265"
		"il-central-1" = "ami-0f2fcaa61509e240b"
		"eu-central-2" = "ami-0a223eb8b1352c111"
		"af-south-1" = "ami-0886cc6308077b7bb"
		"ap-northeast-3" = "ami-03c59f7953881c712"
		"ca-west-1" = "ami-05ef747669a083453"
		"ap-southeast-3" = "ami-0355a3fff7f508e8b"
		"ap-southeast-4" = "ami-033f1fe8503dccce2"
  }
}
