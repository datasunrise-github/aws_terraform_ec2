...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-02c9e8ca99345e988"
		"eu-north-1" = "ami-023be5beea72b8d6c"
		"ap-south-1" = "ami-0fa38edbced349f89"
		"eu-west-3" = "ami-03a596cb590ff2946"
		"eu-west-2" = "ami-00c2473d4d7e51966"
		"eu-west-1" = "ami-0be012fbfbbf7ab80"
		"ap-northeast-2" = "ami-04b5ae65252afb969"
		"me-south-1" = "ami-02a2f07695fb8dc16"
		"ap-northeast-1" = "ami-02ec8ce060fe2363b"
		"sa-east-1" = "ami-02c456b1ed7ae8fc5"
		"ca-central-1" = "ami-08c13cce279e8ba7a"
		"ap-east-1" = "ami-07f54b52c96121c34"
		"ap-southeast-1" = "ami-0b7dbb4720a4fefe8"
		"ap-southeast-2" = "ami-041adeb87e329aeec"
		"us-east-1" = "ami-0757fe17efdb158d0"
		"us-east-2" = "ami-0865b984095fd30d0"
		"us-west-1" = "ami-032800de1051909c6"
		"us-west-2" = "ami-0047c740ea436fd14"
		"ap-south-2" = "ami-04350c2d8a42e5177"
		"eu-south-1" = "ami-038d80ce6e9d0dda2"
		"eu-south-2" = "ami-0459a01230d5a374e"
		"me-central-1" = "ami-0be9440c94c3f282c"
		"il-central-1" = "ami-0e8e52654f90de24d"
		"eu-central-2" = "ami-0305cfda79591f7a9"
		"af-south-1" = "ami-0c0b5c46adfeb31cf"
		"ap-northeast-3" = "ami-03e99bed36d26d9db"
		"ca-west-1" = "ami-01a222dc606795c71"
		"ap-southeast-3" = "ami-028af37553ee21d76"
		"ap-southeast-4" = "ami-08e37b003ce86089b"
  }
}
