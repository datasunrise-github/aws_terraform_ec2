...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-003b809b7f19c2eca"
		"eu-north-1" = "ami-0b4d4716968dbabad"
		"ap-south-1" = "ami-045dabc018c789beb"
		"eu-west-3" = "ami-0bd6db899b5a0dc3b"
		"eu-west-2" = "ami-0050dba860e3b77a2"
		"eu-west-1" = "ami-04c108cedc90f4ee7"
		"ap-northeast-2" = "ami-0067a7ee521e37587"
		"me-south-1" = "ami-03e192918f1f24eb5"
		"ap-northeast-1" = "ami-0f317429f15861f80"
		"sa-east-1" = "ami-0cde293f5dabf2701"
		"ca-central-1" = "ami-0c7fffe4bc2622293"
		"ap-east-1" = "ami-084ef60493bc105d0"
		"ap-southeast-1" = "ami-0f7d6b72b5577ad1c"
		"ap-southeast-2" = "ami-074e88acadc2e44bc"
		"us-east-1" = "ami-0f36f867f8d2ad5fe"
		"us-east-2" = "ami-0b3ab28fd05e8f2f1"
		"us-west-1" = "ami-076020b9285309dd8"
		"us-west-2" = "ami-044350045c34f2152"
		"ap-south-2" = "ami-0124802156fc4b0c6"
		"eu-south-1" = "ami-0e915d4a6de8f6077"
		"eu-south-2" = "ami-0dfd96fa096a84f2b"
		"me-central-1" = "ami-09155881ecab70d31"
		"il-central-1" = "ami-044756debf0fcbd56"
		"eu-central-2" = "ami-049d5ad422675d708"
		"af-south-1" = "ami-05f65ee603121fb41"
		"ap-northeast-3" = "ami-01e67689c92207c3f"
		"ca-west-1" = "ami-0a5943609db8ef192"
		"ap-southeast-3" = "ami-0d28b9b6e1e0b2cb7"
		"ap-southeast-4" = "ami-0d1b0de96a3d93ce4"
  }
}
