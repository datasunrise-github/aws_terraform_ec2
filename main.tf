...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-08853682200cf37a4"
		"eu-north-1" = "ami-0b0068118fc7e34ed"
		"ap-south-1" = "ami-0b6030d04fe273991"
		"eu-west-3" = "ami-040a5c21682a8edd7"
		"eu-west-2" = "ami-055a078e3204e447d"
		"eu-west-1" = "ami-0faf95f3820a73e0f"
		"ap-northeast-2" = "ami-0e8981a183b681478"
		"me-south-1" = "ami-04ba83ddfcbd3e9fa"
		"ap-northeast-1" = "ami-0dd841ee2a799237f"
		"sa-east-1" = "ami-02ec32caeb9ad1fd3"
		"ca-central-1" = "ami-0453150bd15b0e00a"
		"ap-east-1" = "ami-016fccf3f6a95afbc"
		"ap-southeast-1" = "ami-0b937e95267d42871"
		"ap-southeast-2" = "ami-04b09379f8c59c843"
		"us-east-1" = "ami-0fe7149cb142ecca8"
		"us-east-2" = "ami-0fab572da7ab84935"
		"us-west-1" = "ami-0691f375adfb062d8"
		"us-west-2" = "ami-0bbf6208cd7dc624d"
  }
}
