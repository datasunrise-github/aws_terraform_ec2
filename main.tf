...
variable "regions_amis" {
  type    = map
  default = {	
		"eu-central-1" = "ami-0999944e69a3b3b36"
		"eu-north-1" = "ami-016c3f6eb0afc5874"
		"ap-south-1" = "ami-01bbaf377c695ac25"
		"eu-west-3" = "ami-07d69e8d7697e04a0"
		"eu-west-2" = "ami-0f855b86cf3ef87aa"
		"eu-west-1" = "ami-0513cbd0f03fceb78"
		"ap-northeast-2" = "ami-0c63a7ef7f468716c"
		"me-south-1" = "ami-076ed46f403b3f8bb"
		"ap-northeast-1" = "ami-06b231ee0a42a2625"
		"sa-east-1" = "ami-05bafb1fe1704e6c7"
		"ca-central-1" = "ami-0f44ee6ccc1280462"
		"ap-east-1" = "ami-05e26874de1301de8"
		"ap-southeast-1" = "ami-0ee3f38ddb6ffd3fa"
		"ap-southeast-2" = "ami-02e8fa80847da5b73"
		"us-east-1" = "ami-0bb8892e03a71c817"
		"us-east-2" = "ami-0aa6811bbd69664e7"
		"us-west-1" = "ami-068f83fe151a85f0a"
		"us-west-2" = "ami-05af447f35fa66dd6"
  }
}
