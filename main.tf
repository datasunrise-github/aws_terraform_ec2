...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-013599b06128f4909"
		"eu-north-1" = "ami-06f8fa89fb5efff9c"
		"ap-south-1" = "ami-0a337dc5815bdf37a"
		"eu-west-3" = "ami-057a98f7a8c000e5e"
		"eu-west-2" = "ami-051e081f31c4a2af6"
		"eu-west-1" = "ami-05a9fb8df1170045f"
		"ap-northeast-2" = "ami-02a82d64a36dd7730"
		"me-south-1" = "ami-047eea781019bcd2a"
		"ap-northeast-1" = "ami-0262c01ed59a94bd9"
		"sa-east-1" = "ami-06beadcc2c64a7973"
		"ca-central-1" = "ami-00788771618cdd9d7"
		"ap-east-1" = "ami-042a90b62a43f4116"
		"ap-southeast-1" = "ami-08d5beb21f335edb2"
		"ap-southeast-2" = "ami-0bdb99b32fe98caac"
		"us-east-1" = "ami-01c15b7fefe9bd04c"
		"us-east-2" = "ami-0d59e47a345dbfc70"
		"us-west-1" = "ami-05d6508b9092ce4a6"
		"us-west-2" = "ami-0e543e65dac137e7b"
		"ap-south-2" = "ami-0d24874a200dc1d6b"
		"eu-south-1" = "ami-019bb9df33c8f4b2a"
		"eu-south-2" = "ami-099856079665efa55"
		"me-central-1" = "ami-044550ea218338b7d"
		"il-central-1" = "ami-0d9570258be2406c3"
		"eu-central-2" = "ami-00a04747c6d2430dd"
		"af-south-1" = "ami-07bc84b4e2924ae23"
		"ap-northeast-3" = "ami-0e1ee1269d89889fd"
		"ca-west-1" = "ami-0b6bf265da4fa2ba1"
		"ap-southeast-3" = "ami-0e743e8f911d18708"
		"ap-southeast-4" = "ami-0df4a9f731fc4b340"
  }
}
