...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-00af6aa9eedf58236"
		"eu-north-1" = "ami-0cb861bfaa896ca66"
		"ap-south-1" = "ami-0f96c3dfa4dd2dd22"
		"eu-west-3" = "ami-0a6680bcadd8d4683"
		"eu-west-2" = "ami-0c0fad4dffb0df1d6"
		"eu-west-1" = "ami-06071563a3e2a1186"
		"ap-northeast-2" = "ami-0f7c31741a5e39eb9"
		"me-south-1" = "ami-08c645f346766a1ba"
		"ap-northeast-1" = "ami-045cb962601044a67"
		"sa-east-1" = "ami-035a6ae98ae0b3853"
		"ca-central-1" = "ami-04f16d0dbf53f39db"
		"ap-east-1" = "ami-0b70667d3388f312f"
		"ap-southeast-1" = "ami-016366e6d96f515a9"
		"ap-southeast-2" = "ami-00befd539c0cc559b"
		"us-east-1" = "ami-0801f3514f56c3938"
		"us-east-2" = "ami-0485e20fad23ad2ef"
		"us-west-1" = "ami-0eb1af6d07443665a"
		"us-west-2" = "ami-0834d18d4433c1b3c"
		"ap-south-2" = "ami-0d07e301a9d180cf8"
		"eu-south-1" = "ami-0821786e022f65be9"
		"eu-south-2" = "ami-097650a68555bdc1a"
		"me-central-1" = "ami-0f836e4e427b101b4"
		"il-central-1" = "ami-00627825f207c2eb9"
		"eu-central-2" = "ami-0ee01ada41169598f"
		"af-south-1" = "ami-04ae90e7fa4ff7e8d"
		"ap-northeast-3" = "ami-0dccf2d58bdfb97e0"
		"ca-west-1" = "ami-0235115b35fbe184a"
		"ap-southeast-3" = "ami-0c1233e6b184d3885"
		"ap-southeast-4" = "ami-0d06938f0bc39861b"
  }
}
