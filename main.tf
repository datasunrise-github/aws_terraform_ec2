...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-041be4cb4ad78e33b"
		"eu-north-1" = "ami-02ffd20fd19522a47"
		"ap-south-1" = "ami-0442eb434aec24dac"
		"eu-west-3" = "ami-058d0e22ea575e221"
		"eu-west-2" = "ami-0cf228e521940beb5"
		"eu-west-1" = "ami-087a72539c51a6b8e"
		"ap-northeast-2" = "ami-072a448637157eaba"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0d275314371d55a59"
		"sa-east-1" = "ami-024b4bd89b6ce0c2c"
		"ca-central-1" = "ami-0d5b3fb6948a7ca13"
		"ap-east-1" = "ami-0cee80bfc9112fbba"
		"ap-southeast-1" = "ami-0c2fc5a8f00ea764b"
		"ap-southeast-2" = "ami-07cf2caae801d7900"
		"us-east-1" = "ami-0217521c5159fe136"
		"us-east-2" = "ami-045903489c574098e"
		"us-west-1" = "ami-020773b615d38ed2a"
		"us-west-2" = "ami-07f99e1770fcac400"
		"ap-south-2" = "ami-05d0fa28d96f737cb"
		"eu-south-1" = "ami-0e3dd4ba827e308c0"
		"eu-south-2" = "ami-0004231a8f0f596e8"
		"me-central-1" = "ami-013d8509d1ff591e0"
		"il-central-1" = "ami-0322fddd884d6b365"
		"eu-central-2" = "ami-0f5733374dd1b4084"
		"af-south-1" = "ami-02d744975d368a6ca"
		"ap-northeast-3" = "ami-03bd0ac36f48dd777"
		"ca-west-1" = "ami-0ef0336bd901a6fa7"
		"ap-southeast-3" = "ami-07bb483d58ee86fbc"
		"ap-southeast-4" = "ami-04b2857e077698ac2"
  }
}
