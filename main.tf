...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-02cd8dbb8527f01ed"
		"eu-north-1" = "ami-08dec0ce1c7739fe7"
		"ap-south-1" = "ami-022525d42ce91e019"
		"eu-west-3" = "ami-00b0085f046da9665"
		"eu-west-2" = "ami-03a9a401a76ef6832"
		"eu-west-1" = "ami-0593e930294446a21"
		"ap-northeast-2" = "ami-0ad1649457085af55"
		"me-south-1" = "ami-00468f5b16fd09720"
		"ap-northeast-1" = "ami-09f38b6ea8c61d747"
		"sa-east-1" = "ami-0b4c6301be1fdcda6"
		"ca-central-1" = "ami-032b10ce25aff529f"
		"ap-east-1" = "ami-077091f7fec7c641b"
		"ap-southeast-1" = "ami-0d4f5699cd56f309e"
		"ap-southeast-2" = "ami-042d2d0a20bef46c7"
		"us-east-1" = "ami-03a70c8f8787371fa"
		"us-east-2" = "ami-05b99054886b010e4"
		"us-west-1" = "ami-0fdce69c97e83133a"
		"us-west-2" = "ami-057da45f995e0515d"
		"ap-south-2" = "ami-052c5863e2fece3b1"
		"eu-south-1" = "ami-02ab50c48a7d7d6c2"
		"eu-south-2" = "ami-030ebe3e57fce9fae"
		"me-central-1" = "ami-07a28ce3e85c1b879"
		"il-central-1" = "ami-0e2a337e380586aa9"
		"eu-central-2" = "ami-0d7a5cc8886d9945c"
		"af-south-1" = "ami-06e3c7003d9dc4bb8"
		"ap-northeast-3" = "ami-085ea1c3988288fed"
		"ca-west-1" = "ami-0657cb3193da00889"
		"ap-southeast-3" = "ami-061252d790913ffe8"
		"ap-southeast-4" = "ami-0e97d18f1cbaca1a4"
  }
}
