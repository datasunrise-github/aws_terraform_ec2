...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-09d96d9dc9f81393b"
		"eu-north-1" = "ami-0666c3f707a9d80b0"
		"ap-south-1" = "ami-02625454fe75b476f"
		"eu-west-3" = "ami-0b0924cc7cbb0560b"
		"eu-west-2" = "ami-09928946a8fe939ac"
		"eu-west-1" = "ami-08c967aa1491822c7"
		"ap-northeast-2" = "ami-031cf3ee37f45e2a7"
		"me-south-1" = "ami-0f7eac154b727e850"
		"ap-northeast-1" = "ami-0f0fbaf27b23bfbcd"
		"sa-east-1" = "ami-027beb8a11fcc619b"
		"ca-central-1" = "ami-033cd6cd04ad4d9fa"
		"ap-east-1" = "ami-0c25b570d2d090e08"
		"ap-southeast-1" = "ami-0ae4b2f0c4700d590"
		"ap-southeast-2" = "ami-0caf2bb3aea4db1cd"
		"us-east-1" = "ami-08499950cc9b36334"
		"us-east-2" = "ami-095ef74b4b365e436"
		"us-west-1" = "ami-051060f08e980492e"
		"us-west-2" = "ami-09ca24d8f150886bb"
		"ap-south-2" = "ami-04108ffa0839fd889"
		"eu-south-1" = "ami-015c63cfb1b28863d"
		"eu-south-2" = "ami-0367c60eb16bca4a9"
		"me-central-1" = "ami-0ecd60fdc7f8b4eaa"
		"il-central-1" = "ami-0fee268c79f434585"
		"eu-central-2" = "ami-0a9ab59ff5b0ff2b5"
		"af-south-1" = "ami-08ae89f4a214aea90"
		"ap-northeast-3" = "ami-045a1dfe11a54fd70"
		"ca-west-1" = "ami-08bd1dcd9b0793011"
		"ap-southeast-3" = "ami-02081d11684dd9cdd"
		"ap-southeast-4" = "ami-0727033e22e850c9e"
  }
}
