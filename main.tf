...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0bba83d9b71eee1ca"
		"eu-north-1" = "ami-0f0dfd6e764e6e1d6"
		"ap-south-1" = "ami-0ad889522f661f8d3"
		"eu-west-3" = "ami-06053d45ebf6ce3a0"
		"eu-west-2" = "ami-0da7d0cfa834fccbc"
		"eu-west-1" = "ami-09ad5159ae5b093bc"
		"ap-northeast-2" = "ami-084670309518568e3"
		"me-south-1" = "ami-002272c837ea482f1"
		"ap-northeast-1" = "ami-0e074fb89bbaf64f8"
		"sa-east-1" = "ami-03f7196bb0c20ed80"
		"ca-central-1" = "ami-009b3c2bd073e1539"
		"ap-east-1" = "ami-0838c645d2b55b553"
		"ap-southeast-1" = "ami-0c03f018ad1729e86"
		"ap-southeast-2" = "ami-0936b8e06a4f14fc7"
		"us-east-1" = "ami-0a2e026fa3702b3d0"
		"us-east-2" = "ami-0585357ed1f42544f"
		"us-west-1" = "ami-0c5561ca6efa7419f"
		"us-west-2" = "ami-06fd03500d71cf75c"
		"ap-south-2" = "ami-02f0a3c6cde5815cd"
		"eu-south-1" = "ami-0ec4b00aaeaea223d"
		"eu-south-2" = "ami-08fa6fbdd96b11c00"
		"me-central-1" = "ami-079dad06a9cef52c3"
		"il-central-1" = "ami-0b46326e160dd55c6"
		"eu-central-2" = "ami-0ce8500a580d0b458"
		"af-south-1" = "ami-0c5258c4cf0e8d18f"
		"ap-northeast-3" = "ami-036255ac82cd91cb6"
		"ca-west-1" = "ami-006ccc0b3d12cb608"
		"ap-southeast-3" = "ami-0808ed5187cadd0ac"
		"ap-southeast-4" = "ami-0dbd1bdf42b6a2b98"
  }
}
