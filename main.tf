...
variable "regions_amis" {
  ...
  default = {	
		...
		"eu-west-3" = "ami-0cbbf336eaaa6cf92"
		"eu-west-2" = "ami-0ef194fcc1b7ffadf"
		"eu-west-1" = "ami-0285d49bf8ef333f4"
		"ap-northeast-2" = "ami-0b1933d049e8a6c10"
		"me-south-1" = "ami-0cc766777d9e1b429"
		"ap-northeast-1" = "ami-09f6e2669cb63da43"
		"sa-east-1" = "ami-0972587b3bd2b9de6"
		"ca-central-1" = "ami-0b53f34b4b861cd17"
		"ap-east-1" = "ami-0a3ba01d701d3fac6"
		"ap-southeast-1" = "ami-0ef0b9150b3dacf19"
		"ap-southeast-2" = "ami-01648f2303d1c4db5"
		"us-east-1" = "ami-0aeeb436164d95da3"
