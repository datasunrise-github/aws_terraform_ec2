...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0de30cfb0064c308b"
		"eu-north-1" = "ami-0b29488d1c4abd2e0"
		"ap-south-1" = "ami-08af4a905faf734b5"
		"eu-west-3" = "ami-035c4b8383f367861"
		"eu-west-2" = "ami-00ac74f10b5bebebc"
		"eu-west-1" = "ami-0dd24359d3ca4cfe2"
		"ap-northeast-2" = "ami-0fc6f91f588d85acb"
		"me-south-1" = "ami-044ceb2dec8a43ca1"
		"ap-northeast-1" = "ami-01f6f06c5c2e6b089"
		"sa-east-1" = "ami-089651216cfb4cc23"
		"ca-central-1" = "ami-02dfc16f1e05dde60"
		"ap-east-1" = "ami-058f3bca5e665df23"
		"ap-southeast-1" = "ami-037265c5bb76a02ec"
		"ap-southeast-2" = "ami-03a6cfc954c5e72ac"
		"us-east-1" = "ami-0c9e137bcc18dab56"
		"us-east-2" = "ami-0f0f431d3d5edbb61"
		"us-west-1" = "ami-07ed9a92e93016357"
		"us-west-2" = "ami-03dbcc767a1881d56"
		"ap-south-2" = "ami-07fb72f4fbba18418"
		"eu-south-1" = "ami-043d890051f6c3653"
		"eu-south-2" = "ami-0732b8300af613b62"
		"me-central-1" = "ami-03823e0127170817a"
		"il-central-1" = "ami-0ee856a60aff43423"
		"eu-central-2" = "ami-0675128ec81355d71"
		"af-south-1" = "ami-01f58419e97a3dbf5"
		"ap-northeast-3" = "ami-0d0e2baceeaa45de4"
		"ca-west-1" = "ami-074e340056816800f"
		"ap-southeast-3" = "ami-07b2b9d2165950d89"
		"ap-southeast-4" = "ami-0a2f3a0a09c20c805"
  }
}
