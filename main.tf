...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-0506f4835c4b26891"
		"eu-north-1" = "ami-01675566a1f0205d1"
		"ap-south-1" = "ami-0c5d0ab731563987a"
		"eu-west-3" = "ami-0a7a6c7adf63f8803"
		"eu-west-2" = "ami-04fc0fb3ff7868e95"
		"eu-west-1" = "ami-04e827618696895a4"
		"ap-northeast-2" = "ami-0c52b0fc2fd7e25d5"
		"me-south-1" = "ami-07f62c0217822b072"
		"ap-northeast-1" = "ami-0af96e85f273ad7d8"
		"sa-east-1" = "ami-0c12e3838ef75d678"
		"ca-central-1" = "ami-04c5aae64f7da6cdc"
		"ap-east-1" = "ami-02f1a218b9af9852d"
		"ap-southeast-1" = "ami-07f5a25c7e74be131"
		"ap-southeast-2" = "ami-05b5132f6ca41d91e"
		"us-east-1" = "ami-01022b990047f6207"
		"us-east-2" = "ami-0c21f5e61ecfbf15b"
		"us-west-1" = "ami-0bb4afc8125e8d40d"
		"us-west-2" = "ami-093c18cf3e8db83c1"
		"ap-south-2" = "ami-03b3d2a622e70f23e"
		"eu-south-1" = "ami-0774d24a2a724432f"
		"eu-south-2" = "ami-07957acdcac885b15"
		"me-central-1" = "ami-07c04f3ea78a9a02c"
		"il-central-1" = "ami-0a17a2b047fda77b0"
		"eu-central-2" = "ami-0d7d4a53522888c33"
		"af-south-1" = "ami-0a40349a461f46070"
		"ap-northeast-3" = "ami-0d1801a13ccee889a"
		"ca-west-1" = "ami-0dd4ecca55f1c4114"
		"ap-southeast-3" = "ami-00a6d17b1fbd8ddca"
		"ap-southeast-4" = "ami-068459eeaaec0b72f"
  }
}
