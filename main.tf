...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-060a1658c26fa428d"
		"eu-north-1" = "ami-0749bb96fa83fa5bd"
		"ap-south-1" = "ami-0ee67d8d791684cba"
		"eu-west-3" = "ami-06b9a53c682b50806"
		"eu-west-2" = "ami-0fb292660bd578b84"
		"eu-west-1" = "ami-08c30329446399a52"
		"ap-northeast-2" = "ami-0fa4c68e332814cbb"
		"me-south-1" = "ami-0a9829059aa9122aa"
		"ap-northeast-1" = "ami-0fb385c56d1cdec54"
		"sa-east-1" = "ami-0685540c9154f18ea"
		"ca-central-1" = "ami-0b49f2cf75ef6e03a"
		"ap-east-1" = "ami-073577ae735e0b7b8"
		"ap-southeast-1" = "ami-0c15389c784d28d5b"
		"ap-southeast-2" = "ami-0bd62eea9ac3ec21d"
		"us-east-1" = "ami-0cf2a5aa8c08bb87b"
		"us-east-2" = "ami-0b8eb08f829570a99"
		"us-west-1" = "ami-0a8ebcc4f194ed666"
		"us-west-2" = "ami-04e7d230281bb82d4"
		"ap-south-2" = "ami-050943e2f2bd44387"
		"eu-south-1" = "ami-0d89abfb46569552f"
		"eu-south-2" = "ami-0a4479043421d5900"
		"me-central-1" = "ami-0db8c4fe353ac68f0"
		"il-central-1" = "ami-02f48953769dba349"
		"eu-central-2" = "ami-02fb73bee449190eb"
		"af-south-1" = "ami-02db6a722932b90c4"
		"ap-northeast-3" = "ami-08db34650e477709e"
		"ca-west-1" = "ami-08bf5df0f2a57a535"
		"ap-southeast-3" = "ami-0592e115ffd1f70a6"
		"ap-southeast-4" = "ami-0ef1a143bb669235b"
  }
}
