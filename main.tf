...
variable "regions_amis" {
  type    = map
  default = {
		"eu-central-1" = "ami-009c9ca46cc19ba93"
		"eu-north-1" = "ami-0b414cdfedc05f80d"
		"ap-south-1" = "ami-0c0f13822601f9a13"
		"eu-west-3" = "ami-0f2ba7a78991280ac"
		"eu-west-2" = "ami-02c520a416f655448"
		"eu-west-1" = "ami-00f54aec6d3298a4b"
		"ap-northeast-2" = "ami-00f44e3dda49c1a8c"
		"me-south-1" = "ami-00ee6fc34608030f6"
		"ap-northeast-1" = "ami-0a846eb436b5e1f0c"
		"sa-east-1" = "ami-004ccfaac6988dded"
		"ca-central-1" = "ami-03f82e7dd6a85e0ed"
		"ap-east-1" = "ami-0fcd3af9919c68ba4"
		"ap-southeast-1" = "ami-083fb53940d813bd5"
		"ap-southeast-2" = "ami-0dc81e4c80e840d2e"
		"us-east-1" = "ami-0ffbe974f72273a5e"
		"us-east-2" = "ami-00551951a756f1aac"
		"us-west-1" = "ami-0bed6f6240cb51670"
		"us-west-2" = "ami-0281613174b12c4ad"
		"ap-south-2" = "ami-014f194fe4f35f58a"
		"eu-south-1" = "ami-035c69f7f4cefdda7"
		"eu-south-2" = "ami-0690d9a6342618a1f"
		"me-central-1" = "ami-0394b3984ba0b3a49"
		"il-central-1" = "ami-0bea362da5d79988c"
		"eu-central-2" = "ami-0e46de4a0675debe4"
		"af-south-1" = "ami-0650ebc1bcc90051b"
		"ap-northeast-3" = "ami-0fc8290f76d571692"
		"ca-west-1" = "ami-0e2d8a2f0e0654da5"
		"ap-southeast-3" = "ami-0ff6bd60be853c0f0"
		"ap-southeast-4" = "ami-0e18620711ec98db0"
  }
}
